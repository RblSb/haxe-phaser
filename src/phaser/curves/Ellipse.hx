...
@:native("Phaser.Curves.Ellipse") extern class Ellipse extends Curve {
	function new(?x:ts.AnyOf2<Float, phaser.types.curves.EllipseCurveConfig>, ?y:Float, ?xRadius:Float, ?yRadius:Float, ?startAngle:Float, ?endAngle:Float, ?clockwise:Bool, ?rotation:Float);
	/**
	...
	**/
	function toJSON():phaser.types.curves.JSONEllipseCurve;
	static var prototype : Ellipse;
	/**
		Creates a curve from the provided Ellipse Curve Configuration object.
	**/
	static function fromJSON(data:phaser.types.curves.JSONEllipseCurve):Ellipse;
}