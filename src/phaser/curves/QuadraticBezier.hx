...
@:native("Phaser.Curves.QuadraticBezier") extern class QuadraticBezier extends Curve {
	function new(p0:ts.AnyOf2<phaser.math.Vector2, Array<Float>>, p1:phaser.math.Vector2, p2:phaser.math.Vector2);
	/**
		The start point.
	**/
	...
	**/
	static function fromJSON(data:phaser.types.curves.JSONCurve):QuadraticBezier;
}