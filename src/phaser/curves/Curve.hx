...
@:native("Phaser.Curves.Curve") extern class Curve {
	...
	**/
	function getBounds(?out:phaser.geom.Rectangle, ?accuracy:Float):phaser.geom.Rectangle;
	/**
		Returns an array of points, spaced out X distance pixels apart.
		The smaller the distance, the larger the array will be.
	**/
	function getDistancePoints(distance:Float):Array<phaser.geom.Point>;
	/**
		Get a point at the end of the curve.
	**/
	function getEndPoint(?out:phaser.math.Vector2):phaser.math.Vector2;
	/**
	...
	**/
	...
	/**
		...
		`1 + divisions` points will be returned.
	**/
	function getSpacedPoints(?divisions:Float, ?stepRate:Float, ?out:ts.AnyOf2<Array<Dynamic>, Array<phaser.math.Vector2>>):Array<phaser.math.Vector2>;
	/**
