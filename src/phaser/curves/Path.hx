...
@:native("Phaser.Curves.Path") extern class Path {
	...
	**/
	var startPoint : phaser.math.Vector2;
	/**
	...
	**/
	function cubicBezierTo(x:ts.AnyOf2<Float, phaser.math.Vector2>, y:ts.AnyOf2<Float, phaser.math.Vector2>, control1X:ts.AnyOf2<Float, phaser.math.Vector2>, ?control1Y:Float, ?control2X:Float, ?control2Y:Float):Path;
	/**
		Creates a Quadratic Bezier Curve starting at the ending point of the Path.
	**/
	function quadraticBezierTo(x:ts.AnyOf2<Float, Array<phaser.math.Vector2>>, ?y:Float, ?controlX:Float, ?controlY:Float):Path;
	/**
		Draws all Curves in the Path to a Graphics Game Object.
	**/
	function draw<G>(graphics:phaser.gameobjects.Graphics, ?pointsTotal:Float):G;
	/**
	...
	**/
	function fromJSON(data:phaser.types.curves.JSONPath):Path;
	/**
	...
	**/
	function getCurveAt(t:Float):Null<Curve>;
	/**
	...
	**/
	function getPoints(?divisions:Float, ?stepRate:Float):Array<phaser.math.Vector2>;
	/**
	...
	**/
	function getSpacedPoints(?divisions:Float):Array<phaser.math.Vector2>;
	/**
	...
	**/
	function lineTo(x:ts.AnyOf3<Float, phaser.math.Vector2, phaser.types.math.Vector2Like>, ?y:Float):Path;
	/**
		Creates a spline curve starting at the previous end point, using the given points on the curve.
	**/
	function splineTo(points:Array<phaser.math.Vector2>):Path;
	/**
	...
	**/
	function moveTo(x:ts.AnyOf3<Float, phaser.math.Vector2, phaser.types.math.Vector2Like>, ?y:Float):Path;
	/**
		Converts this Path to a JSON object containing the path information and its constituent curves.
	**/
	function toJSON():phaser.types.curves.JSONPath;
	/**
