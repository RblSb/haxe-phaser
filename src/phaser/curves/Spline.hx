...
@:native("Phaser.Curves.Spline") extern class Spline extends Curve {
	function new(?points:ts.AnyOf3<Array<Float>, Array<phaser.math.Vector2>, Array<Array<Float>>>);
	/**
		The Vector2 points that configure the curve.
	**/
	var points : Array<phaser.math.Vector2>;
	/**
		Add a list of points to the current list of Vector2 points of the curve.
	**/
	function addPoints(points:ts.AnyOf3<Array<Float>, Array<phaser.math.Vector2>, Array<Array<Float>>>):Spline;
	/**
		Add a point to the current list of Vector2 points of the curve.
	**/
	function addPoint(x:Float, y:Float):phaser.math.Vector2;
	/**
	...
	**/
	static function fromJSON(data:phaser.types.curves.JSONCurve):Spline;
}