...
**/
@:native("Phaser.Cameras.Scene2D.BaseCamera") extern class BaseCamera extends phaser.events.EventEmitter {
	...
	**/
	var sceneManager : phaser.scenes.SceneManager;
	/**
		A reference to the Game Scale Manager.
	**/
	var scaleManager : phaser.scale.ScaleManager;
	/**
	...
	**/
	final worldView : phaser.geom.Rectangle;
	/**
	...
	**/
	...
	/**
		...
		have been processed.
	**/
	final midPoint : phaser.math.Vector2;
	/**
	...
	**/
	var mask : Null<ts.AnyOf2<phaser.display.masks.BitmapMask, phaser.display.masks.GeometryMask>>;
	/**
	...
	**/
	var renderList : Array<phaser.gameobjects.GameObject>;
	/**
	...
	**/
	function addToRenderList(child:phaser.gameobjects.GameObject):Void;
	/**
	...
	**/
	function getScroll(x:Float, y:Float, ?out:phaser.math.Vector2):phaser.math.Vector2;
	/**
	...
	**/
	function setBackgroundColor(?color:ts.AnyOf3<String, Float, phaser.types.display.InputColorObject>):BaseCamera;
	/**
	...
	**/
	function getBounds(?out:phaser.geom.Rectangle):phaser.geom.Rectangle;
	/**
	...
	**/
	function setScene(scene:phaser.Scene, ?isSceneCamera:Bool):BaseCamera;
	/**
	...
	**/
	function setMask(mask:ts.AnyOf2<phaser.display.masks.BitmapMask, phaser.display.masks.GeometryMask>, ?fixedPosition:Bool):BaseCamera;
	/**
	...
	**/
	function toJSON():phaser.types.cameras.scene2d.JSONCamera;
	/**
	...
	**/
	...
	/**
		...
		Camera.
	**/
	function setIsSceneCamera(value:Bool):Void;
	/**
