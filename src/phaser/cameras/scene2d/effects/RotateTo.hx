...
@:native("Phaser.Cameras.Scene2D.Effects.RotateTo") extern class RotateTo {
	...
	**/
	...
	/**
		...
		over the duration and with the ease specified.
	**/
	function start(radians:Float, ?shortestPath:Bool, ?duration:Float, ?ease:ts.AnyOf2<String, haxe.Constraints.Function>, ?force:Bool, ?callback:CameraRotateCallback, ?context:Dynamic):phaser.cameras.scene2d.Camera;
	/**
