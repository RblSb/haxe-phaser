...
@:native("Phaser.Cameras.Scene2D.Effects.Shake") extern class Shake {
	...
	**/
	var intensity : phaser.math.Vector2;
	/**
	...
	**/
	function start(?duration:Float, ?intensity:ts.AnyOf2<Float, phaser.math.Vector2>, ?force:Bool, ?callback:phaser.types.cameras.scene2d.CameraShakeCallback, ?context:Dynamic):phaser.cameras.scene2d.Camera;
	/**
