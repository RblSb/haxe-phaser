...
@:native("Phaser.Cameras.Scene2D.Effects.Zoom") extern class Zoom {
	...
	**/
	...
	/**
		This effect will zoom the Camera to the given scale, over the duration and with the ease specified.
	**/
	function start(zoom:Float, ?duration:Float, ?ease:ts.AnyOf2<String, haxe.Constraints.Function>, ?force:Bool, ?callback:phaser.types.cameras.scene2d.CameraZoomCallback, ?context:Dynamic):phaser.cameras.scene2d.Camera;
	/**
