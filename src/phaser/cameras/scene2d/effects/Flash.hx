...
@:native("Phaser.Cameras.Scene2D.Effects.Flash") extern class Flash {
	...
	**/
	function start(?duration:Float, ?red:Float, ?green:Float, ?blue:Float, ?force:Bool, ?callback:phaser.types.cameras.scene2d.CameraFlashCallback, ?context:Dynamic):phaser.cameras.scene2d.Camera;
	/**
