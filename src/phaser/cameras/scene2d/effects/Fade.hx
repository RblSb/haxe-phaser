...
@:native("Phaser.Cameras.Scene2D.Effects.Fade") extern class Fade {
	function new(camera:phaser.cameras.scene2d.Camera);
	/**
		The Camera this effect belongs to.
	**/
	final camera : phaser.cameras.scene2d.Camera;
	/**
	...
	**/
	function start(?direction:Bool, ?duration:Float, ?red:Float, ?green:Float, ?blue:Float, ?force:Bool, ?callback:phaser.types.cameras.scene2d.CameraFadeCallback, ?context:Dynamic):phaser.cameras.scene2d.Camera;
	/**
	...
	**/
	function postRenderWebGL(pipeline:phaser.renderer.webgl.pipelines.MultiPipeline, getTintFunction:haxe.Constraints.Function):Bool;
	/**
