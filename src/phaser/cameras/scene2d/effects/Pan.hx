...
@:native("Phaser.Cameras.Scene2D.Effects.Pan") extern class Pan {
	...
	**/
	...
	/**
		...
		over the duration and with the ease specified.
	**/
	function start(x:Float, y:Float, ?duration:Float, ?ease:ts.AnyOf2<String, haxe.Constraints.Function>, ?force:Bool, ?callback:phaser.types.cameras.scene2d.CameraPanCallback, ?context:Dynamic):phaser.cameras.scene2d.Camera;
	/**
