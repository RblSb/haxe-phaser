...
@:native("Phaser.Cameras.Scene2D.CameraManager") extern class CameraManager {
	...
	**/
	function addExisting(camera:Camera, ?makeMain:Bool):Null<Camera>;
	/**
	...
	**/
	function fromJSON(config:ts.AnyOf2<phaser.types.cameras.scene2d.CameraConfig, Array<phaser.types.cameras.scene2d.CameraConfig>>):CameraManager;
	/**
	...
	**/
	function getCamera(name:String):Null<Camera>;
	/**
		Returns an array of all cameras below the given Pointer.
		
		The first camera in the array is the top-most camera in the camera list.
	**/
	function getCamerasBelowPointer(pointer:phaser.input.Pointer):Array<Camera>;
	/**
	...
	**/
	...
	/**
		...
		an alpha level > 0.
	**/
	private function render(renderer:ts.AnyOf2<phaser.renderer.canvas.CanvasRenderer, phaser.renderer.webgl.WebGLRenderer>, displayList:phaser.gameobjects.DisplayList):Void;
	/**
	...
	**/
	function getVisibleChildren(children:Array<phaser.gameobjects.GameObject>, camera:Camera):Array<phaser.gameobjects.GameObject>;
	/**
