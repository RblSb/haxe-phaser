...
@:native("Phaser.Data.DataManager") extern class DataManager {
	function new(parent:Dynamic, ?eventEmitter:phaser.events.EventEmitter);
	/**
	...
	**/
	...
	/**
		The data list.
	**/
	var list : haxe.DynamicAccess<Dynamic>;
	/**
	...
	**/
	function getAll():haxe.DynamicAccess<Dynamic>;
	/**
		Queries the DataManager for the values of keys matching the given regular expression.
	**/
	function query(search:js.lib.RegExp):haxe.DynamicAccess<Dynamic>;
	/**
	...
	**/
	...
	/**
		...
		When the value is first set, a `setdata` event is emitted.
	**/
	function toggle(key:String):DataManager;
	/**
		Passes all data entries to the given callback.
	**/
	function each(callback:DataEachCallback, ?context:Dynamic, args:haxe.extern.Rest<Dynamic>):DataManager;
	/**
	...
	**/
	function merge(data:haxe.DynamicAccess<Dynamic>, ?overwrite:Bool):DataManager;
	/**
