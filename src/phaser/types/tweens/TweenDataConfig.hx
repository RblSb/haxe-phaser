...
typedef TweenDataConfig = {
	...
	**/
	@:optional
	dynamic function getActiveValue(target:Dynamic, key:String, value:Float, targetIndex:Float, totalTargets:Float, tween:phaser.tweens.Tween):Float;
	/**
		The returned value sets what the property will be at the END of the Tween.
	**/
	dynamic function getEndValue(target:Dynamic, key:String, value:Float, targetIndex:Float, totalTargets:Float, tween:phaser.tweens.Tween):Float;
	/**
		The returned value sets what the property will be at the START of the Tween.
	**/
	dynamic function getStartValue(target:Dynamic, key:String, value:Float, targetIndex:Float, totalTargets:Float, tween:phaser.tweens.Tween):Float;
	/**
