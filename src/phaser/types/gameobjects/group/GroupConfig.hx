...
typedef GroupConfig = {
	...
	**/
	@:optional
	dynamic function createCallback(item:phaser.gameobjects.GameObject):Void;
	/**
		Sets {@link Phaser.GameObjects.Group#removeCallback}.
	**/
	@:optional
	dynamic function removeCallback(item:phaser.gameobjects.GameObject):Void;
	/**
		Sets {@link Phaser.GameObjects.Group#createMultipleCallback}.
	**/
	@:optional
	dynamic function createMultipleCallback(items:Array<phaser.gameobjects.GameObject>):Void;
};