...
typedef GroupCreateConfig = {
	...
	**/
	@:optional
	dynamic function hitAreaCallback(hitArea:Dynamic, x:Float, y:Float, gameObject:phaser.gameobjects.GameObject):Bool;
	/**
		Align the new Game Objects in a grid using these settings.
	**/
	@:optional
	var gridAlign : ts.AnyOf2<Bool, phaser.types.actions.GridAlignConfig>;
};