...
typedef MatterBodyConfig = {
	...
	**/
	@:optional
	var shape : ts.AnyOf2<String, MatterSetBodyConfig>;
	/**
	...
	**/
	@:optional
	var parts : Array<matterjs.BodyType>;
	/**
	...
	**/
	@:optional
	var vertices : Array<phaser.types.math.Vector2Like>;
	/**
		A `Vector` that specifies the current world-space position of the body.
	**/
	@:optional
	var position : phaser.types.math.Vector2Like;
	/**
		A `Vector` that specifies the force to apply in the current step. It is zeroed after every `Body.update`. See also `Body.applyForce`.
	**/
	@:optional
	var force : phaser.types.math.Vector2Like;
	/**
	...
	**/
	@:optional
	var scale : phaser.types.math.Vector2Like;
	/**
		A `Vector` that scales the influence of World gravity when applied to this body.
	**/
	@:optional
	var gravityScale : phaser.types.math.Vector2Like;
	/**
