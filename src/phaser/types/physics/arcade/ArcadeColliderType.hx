...
**/
typedef ArcadeColliderType = ts.AnyOf15<phaser.gameobjects.GameObject, phaser.gameobjects.Group, phaser.physics.arcade.Body, phaser.physics.arcade.Sprite, phaser.physics.arcade.Image, phaser.physics.arcade.StaticGroup, phaser.physics.arcade.Group, phaser.tilemaps.TilemapLayer, Array<phaser.physics.arcade.Body>, Array<phaser.gameobjects.GameObject>, Array<phaser.physics.arcade.Sprite>, Array<phaser.physics.arcade.Image>, Array<phaser.physics.arcade.StaticGroup>, Array<phaser.physics.arcade.Group>, Array<phaser.tilemaps.TilemapLayer>>;