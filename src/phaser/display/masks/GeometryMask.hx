...
@:native("Phaser.Display.Masks.GeometryMask") extern class GeometryMask {
	function new(scene:phaser.Scene, graphicsGeometry:phaser.gameobjects.Graphics);
	/**
		The Graphics object which describes the Geometry Mask.
	**/
	var geometryMask : phaser.gameobjects.Graphics;
	/**
	...
	**/
	function setShape(graphicsGeometry:phaser.gameobjects.Graphics):GeometryMask;
	/**
	...
	**/
	function preRenderWebGL(renderer:phaser.renderer.webgl.WebGLRenderer, child:phaser.gameobjects.GameObject, camera:phaser.cameras.scene2d.Camera):Void;
	/**
		Applies the current stencil mask to the renderer.
	**/
	function applyStencil(renderer:phaser.renderer.webgl.WebGLRenderer, camera:phaser.cameras.scene2d.Camera, inc:Bool):Void;
	/**
		Flushes all rendered pixels and disables the stencil test of a WebGL context, thus disabling the mask for it.
	**/
	function postRenderWebGL(renderer:phaser.renderer.webgl.WebGLRenderer):Void;
	/**
		Sets the clipping path of a 2D canvas context to the Geometry Mask's underlying Graphics object.
	**/
	function preRenderCanvas(renderer:phaser.renderer.canvas.CanvasRenderer, mask:phaser.gameobjects.GameObject, camera:phaser.cameras.scene2d.Camera):Void;
	/**
		Restore the canvas context's previous clipping path, thus turning off the mask for it.
	**/
	function postRenderCanvas(renderer:phaser.renderer.canvas.CanvasRenderer):Void;
	/**
