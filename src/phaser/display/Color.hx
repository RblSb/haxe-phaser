...
@:native("Phaser.Display.Color") extern class Color {
	...
	**/
	function setFromRGB(color:phaser.types.display.InputColorObject):Color;
	/**
	...
	**/
	static function ColorSpectrum(?limit:Float):Array<phaser.types.display.ColorObject>;
	/**
		Converts the given color value into an Object containing r,g,b and a properties.
	**/
	static function ColorToRGBA(color:Float):phaser.types.display.ColorObject;
	/**
	...
	**/
	static function HSVColorWheel(?s:Float, ?v:Float):Array<phaser.types.display.ColorObject>;
	/**
	...
	**/
	static function IntegerToRGB(input:Float):phaser.types.display.ColorObject;
	/**
	...
	**/
	...
	/**
		...
		Based on code by Michael Jackson (https://github.com/mjijackson)
	**/
	static function RGBToHSV(r:Float, g:Float, b:Float, ?out:ts.AnyOf2<Color, phaser.types.display.HSVColorObject>):ts.AnyOf2<Color, phaser.types.display.HSVColorObject>;
	/**
	...
	**/
	static function ValueToColor(input:ts.AnyOf3<String, Float, phaser.types.display.InputColorObject>):Color;
}