...
@:native("Phaser.Display.Bounds") @valueModuleOnly extern class Bounds {
	...
	**/
	static function GetBottom(gameObject:phaser.gameobjects.GameObject):Float;
	/**
		Returns the unrotated bounds of the Game Object as a rectangle.
	**/
	static function GetBounds(gameObject:phaser.gameobjects.GameObject, ?output:ts.AnyOf2<Dynamic, phaser.geom.Rectangle>):ts.AnyOf2<Dynamic, phaser.geom.Rectangle>;
	/**
		Returns the center x coordinate from the bounds of the Game Object.
	**/
	static function GetCenterX(gameObject:phaser.gameobjects.GameObject):Float;
	/**
		Returns the center y coordinate from the bounds of the Game Object.
	**/
	static function GetCenterY(gameObject:phaser.gameobjects.GameObject):Float;
	/**
		Returns the left coordinate from the bounds of the Game Object.
	**/
	static function GetLeft(gameObject:phaser.gameobjects.GameObject):Float;
	/**
	...
	**/
	static function GetOffsetX(gameObject:phaser.gameobjects.GameObject):Float;
	/**
	...
	**/
	static function GetOffsetY(gameObject:phaser.gameobjects.GameObject):Float;
	/**
		Returns the right coordinate from the bounds of the Game Object.
	**/
	static function GetRight(gameObject:phaser.gameobjects.GameObject):Float;
	/**
		Returns the top coordinate from the bounds of the Game Object.
	**/
	static function GetTop(gameObject:phaser.gameobjects.GameObject):Float;
	/**
