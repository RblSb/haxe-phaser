...
@:native("Phaser.Tilemaps") @valueModuleOnly extern class Tilemaps {
	...
	**/
	static function ParseToTilemap(scene:Scene, ?key:String, ?tileWidth:Float, ?tileHeight:Float, ?width:Float, ?height:Float, ?data:Array<Array<Float>>, ?insertNull:Bool):phaser.tilemaps.Tilemap;
	/**
