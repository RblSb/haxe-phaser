...
@:native("Phaser.DOM") @valueModuleOnly extern class DOM {
	...
	**/
	static function DOMContentLoaded(callback:ContentLoadedCallback):Void;
	/**
	...
	**/
	static function ParseXML(data:String):Null<ts.AnyOf2<js.lib.ActiveXObject, js.html.DOMParser>>;
	/**
