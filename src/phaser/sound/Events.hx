...
@:native("Phaser.Sound.Events") @valueModuleOnly extern class Events {
	...
	**/
	...
	/**
		...
		```
	**/
	static final DECODED_ALL : String;
	/**
	...
	**/
	static final GLOBAL_DETUNE : String;
	/**
	...
	**/
	static final GLOBAL_MUTE : String;
	/**
		...
		Listen to it from a Scene using: `this.sound.on('rate', listener)`.
	**/
	static final GLOBAL_RATE : String;
	/**
	...
	**/
	static final GLOBAL_VOLUME : String;
	/**
	...
	**/
	static final RESUME_ALL : String;
	/**
