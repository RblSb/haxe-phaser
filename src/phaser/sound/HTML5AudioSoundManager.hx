...
@:native("Phaser.Sound.HTML5AudioSoundManager") extern class HTML5AudioSoundManager extends BaseSoundManager {
	...
	**/
	function add(key:String, ?config:phaser.types.sound.SoundConfig):HTML5AudioSound;
	/**
	...
	**/
	function setRate(value:Float):HTML5AudioSoundManager;
	/**
		Sets the global detuning of all sounds in [cents](https://en.wikipedia.org/wiki/Cent_%28music%29).
		The range of the value is -1200 to 1200, but we recommend setting it to [50](https://en.wikipedia.org/wiki/50_Cent).
	**/
	function setDetune(value:Float):HTML5AudioSoundManager;
	/**
