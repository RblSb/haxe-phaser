...
@:native("Phaser.Utils.Array") @valueModuleOnly extern class Array_ {
	...
	**/
	static function Flatten(array:Array<Dynamic>, ?output:Array<Dynamic>):Array<Dynamic>;
	/**
	...
	**/
	static function GetFirst(array:Array<Dynamic>, ?property:String, ?value:Dynamic, ?startIndex:Float, ?endIndex:Float):Null<Dynamic>;
	/**
