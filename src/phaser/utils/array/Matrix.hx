...
@:native("Phaser.Utils.Array.Matrix") @valueModuleOnly extern class Matrix {
	...
	**/
	...
	/**
		...
		```
	**/
	static function RotateLeft<T>(?matrix:Array<Array<T>>, ?amount:Float):Array<Array<T>>;
	/**
	...
	**/
	...
	/**
		...
		```
	**/
	static function RotateRight<T>(?matrix:Array<Array<T>>, ?amount:Float):Array<Array<T>>;
	/**
