...
@:native("Phaser.GameObjects.Text") extern class Text extends GameObject {
	function new(scene:phaser.Scene, x:Float, y:Float, text:ts.AnyOf2<String, Array<String>>, style:phaser.types.gameobjects.text.TextStyle);
	/**
	...
	**/
	var padding : phaser.types.gameobjects.text.TextPadding;
	/**
	...
	**/
	...
	/**
		...
		An array of strings will be joined with `\n` line breaks.
	**/
	function appendText(value:ts.AnyOf2<String, Array<String>>, ?addCR:Bool):Text;
	/**
		Set the text style.
	**/
	...
	**/
	function setFill(color:ts.AnyOf3<String, js.html.CanvasGradient, js.html.CanvasPattern>):Text;
	/**
		Set the text fill color.
	**/
	function setColor(color:ts.AnyOf3<String, js.html.CanvasGradient, js.html.CanvasPattern>):Text;
	/**
		Set the stroke settings.
	**/
	function setStroke(color:ts.AnyOf3<String, js.html.CanvasGradient, js.html.CanvasPattern>, thickness:Float):Text;
	/**
	...
	**/
	function setWordWrapCallback(callback:TextStyleWordWrapCallback, ?scope:Dynamic):Text;
	/**
	...
	**/
	function setLetterSpacing(value:Float):Text;
	/**
	...
	**/
	function setPadding(left:ts.AnyOf2<Float, phaser.types.gameobjects.text.TextPadding>, ?top:Float, ?right:Float, ?bottom:Float):Text;
	/**
	...
	**/
	function getTextMetrics():phaser.types.gameobjects.text.TextMetrics;
	/**
	...
	**/
	...
	/**
		...
		* ERASE (only works when rendering to a framebuffer, like a Render Texture)
		...
		are used.
	**/
	function setBlendMode(value:ts.AnyOf3<String, Float, phaser.BlendModes>):Text;
	/**
	...
	**/
	function setCrop(?x:ts.AnyOf2<Float, phaser.geom.Rectangle>, ?y:Float, ?width:Float, ?height:Float):Text;
	/**
	...
	**/
	...
	/**
		...
		This method does not change this Game Objects `depth` value, it simply alters its list position.
	**/
	function setAbove(gameObject:GameObject):Text;
	/**
		...
		This method does not change this Game Objects `depth` value, it simply alters its list position.
	**/
	function setBelow(gameObject:GameObject):Text;
	/**
	...
	**/
	function setMask(mask:ts.AnyOf2<phaser.display.masks.BitmapMask, phaser.display.masks.GeometryMask>):Text;
	/**
	...
	**/
	function setPipeline(pipeline:ts.AnyOf2<String, phaser.renderer.webgl.WebGLPipeline>, ?pipelineData:Dynamic, ?copyData:Bool):Text;
	/**
	...
	**/
	function setPostPipeline(pipelines:ts.AnyOf6<String, haxe.Constraints.Function, Array<String>, Array<haxe.Constraints.Function>, phaser.renderer.webgl.pipelines.PostFXPipeline, Array<phaser.renderer.webgl.pipelines.PostFXPipeline>>, ?pipelineData:Dynamic, ?copyData:Bool):Text;
	/**
		...
		If `value` is undefined, and `key` exists, `key` is removed from the data object.
	**/
	function setPostPipelineData(key:String, ?value:Dynamic):Text;
	/**
	...
	**/
	function removePostPipeline(pipeline:ts.AnyOf2<String, phaser.renderer.webgl.pipelines.PostFXPipeline>):Text;
	/**
	...
	**/
	function copyPosition(source:ts.AnyOf3<phaser.types.math.Vector2Like, phaser.types.math.Vector3Like, phaser.types.math.Vector4Like>):Text;
	/**
	...
	**/
	function setData<T>(key:ts.AnyOf2<String, T>, ?data:Dynamic):Text;
	/**
		...
		When the value is first set, a `setdata` event is emitted from this Game Object.
	**/
	function incData(key:String, ?amount:Float):Text;
	/**
		...
		When the value is first set, a `setdata` event is emitted from this Game Object.
	**/
	function toggleData(key:String):Text;
	/**
	...
	**/
	function setInteractive(?hitArea:Dynamic, ?callback:phaser.types.input.HitAreaCallback, ?dropZone:Bool):Text;
	/**
	...
	**/
	function disableInteractive(?resetCursor:Bool):Text;
	/**
	...
	**/
	function removeInteractive(?resetCursor:Bool):Text;
	/**
	...
	**/
	function addToDisplayList(?displayList:ts.AnyOf2<Layer, DisplayList>):Text;
	/**
	...
	**/
	...
	/**
		...
		disable it from rendering, consider using the `setVisible` method, instead.
	**/
	function removeFromDisplayList():Text;
	/**
		...
		run animations.
	**/
	function removeFromUpdateList():Text;
	/**
