...
@:native("Phaser.GameObjects.BitmapText") extern class BitmapText extends GameObject {
	...
	**/
	final fontData : phaser.types.gameobjects.bitmaptext.BitmapFontData;
	/**
	...
	**/
	function setLineSpacing(?spacing:Float):BitmapText;
	/**
	...
	**/
	function getTextBounds(?round:Bool):phaser.types.gameobjects.bitmaptext.BitmapTextSize;
	/**
	...
	**/
	function getCharacterAt(x:Float, y:Float, ?camera:phaser.cameras.scene2d.Camera):phaser.types.gameobjects.bitmaptext.BitmapTextCharacter;
	/**
	...
	**/
	function toJSON():phaser.types.gameobjects.bitmaptext.JSONBitmapText;
	/**
	...
	**/
	...
	/**
		...
		* ERASE (only works when rendering to a framebuffer, like a Render Texture)
		...
		are used.
	**/
	function setBlendMode(value:ts.AnyOf3<String, Float, phaser.BlendModes>):BitmapText;
	/**
	...
	**/
	...
	/**
		...
		This method does not change this Game Objects `depth` value, it simply alters its list position.
	**/
	function setAbove(gameObject:GameObject):BitmapText;
	/**
		...
		This method does not change this Game Objects `depth` value, it simply alters its list position.
	**/
	function setBelow(gameObject:GameObject):BitmapText;
	/**
	...
	**/
	function setMask(mask:ts.AnyOf2<phaser.display.masks.BitmapMask, phaser.display.masks.GeometryMask>):BitmapText;
	/**
	...
	**/
	function setPipeline(pipeline:ts.AnyOf2<String, phaser.renderer.webgl.WebGLPipeline>, ?pipelineData:Dynamic, ?copyData:Bool):BitmapText;
	/**
	...
	**/
	function setPostPipeline(pipelines:ts.AnyOf6<String, haxe.Constraints.Function, Array<String>, Array<haxe.Constraints.Function>, phaser.renderer.webgl.pipelines.PostFXPipeline, Array<phaser.renderer.webgl.pipelines.PostFXPipeline>>, ?pipelineData:Dynamic, ?copyData:Bool):BitmapText;
	/**
		...
		If `value` is undefined, and `key` exists, `key` is removed from the data object.
	**/
	function setPostPipelineData(key:String, ?value:Dynamic):BitmapText;
	/**
	...
	**/
	function removePostPipeline(pipeline:ts.AnyOf2<String, phaser.renderer.webgl.pipelines.PostFXPipeline>):BitmapText;
	/**
	...
	**/
	function setTexture(key:ts.AnyOf2<String, phaser.textures.Texture>, ?frame:ts.AnyOf2<String, Float>, ?updateSize:Bool, ?updateOrigin:Bool):BitmapText;
	/**
		...
		It will also change the `origin` if the Frame has a custom pivot point, as exported from packages like Texture Packer.
	**/
	function setFrame(frame:ts.AnyOf3<String, Float, phaser.textures.Frame>, ?updateSize:Bool, ?updateOrigin:Bool):BitmapText;
	/**
	...
	**/
	function copyPosition(source:ts.AnyOf3<phaser.types.math.Vector2Like, phaser.types.math.Vector3Like, phaser.types.math.Vector4Like>):BitmapText;
	/**
	...
	**/
	function setData<T>(key:ts.AnyOf2<String, T>, ?data:Dynamic):BitmapText;
	/**
		...
		When the value is first set, a `setdata` event is emitted from this Game Object.
	**/
	function incData(key:String, ?amount:Float):BitmapText;
	/**
		...
		When the value is first set, a `setdata` event is emitted from this Game Object.
	**/
	function toggleData(key:String):BitmapText;
	/**
	...
	**/
	function setInteractive(?hitArea:Dynamic, ?callback:phaser.types.input.HitAreaCallback, ?dropZone:Bool):BitmapText;
	/**
	...
	**/
	function disableInteractive(?resetCursor:Bool):BitmapText;
	/**
	...
	**/
	function removeInteractive(?resetCursor:Bool):BitmapText;
	/**
	...
	**/
	function addToDisplayList(?displayList:ts.AnyOf2<Layer, DisplayList>):BitmapText;
	/**
	...
	**/
	function addToUpdateList():BitmapText;
	/**
		...
		disable it from rendering, consider using the `setVisible` method, instead.
	**/
	function removeFromDisplayList():BitmapText;
	/**
		...
		run animations.
	**/
	function removeFromUpdateList():BitmapText;
	/**
	...
	**/
	static function ParseFromAtlas(scene:phaser.Scene, fontName:String, textureKey:String, frameKey:String, xmlKey:String, ?xSpacing:Float, ?ySpacing:Float):Bool;
	/**
		Parse an XML font to Bitmap Font data for the Bitmap Font cache.
	**/
	static function ParseXMLBitmapFont(xml:js.html.XMLDocument, frame:phaser.textures.Frame, ?xSpacing:Float, ?ySpacing:Float):phaser.types.gameobjects.bitmaptext.BitmapFontData;
}