...
@:native("Phaser.GameObjects.DOMElement") extern class DOMElement extends GameObject {
	function new(scene:phaser.Scene, ?x:Float, ?y:Float, ?element:ts.AnyOf2<String, js.html.DOMElement>, ?style:Dynamic, ?innerText:String);
	/**
	...
	**/
	var cache : phaser.cache.BaseCache;
	/**
	...
	**/
	var rotate3d : phaser.math.Vector4;
	/**
	...
	**/
	...
	/**
		...
		Any event listeners you may have previously created will need to be re-created after this call.
	**/
	function createFromHTML(html:String, ?tagName:String):DOMElement;
	/**
	...
	**/
	function getChildByProperty(property:String, value:String):Null<js.html.DOMElement>;
	/**
		Gets all children from this DOM Elements node, using `querySelectorAll('*')` and then iterates through
	...
	**/
	function getChildByID(id:String):Null<js.html.DOMElement>;
	/**
		Gets all children from this DOM Elements node, using `querySelectorAll('*')` and then iterates through
		...
		Be aware that class and id names are case-sensitive.
	**/
	function getChildByName(name:String):Null<js.html.DOMElement>;
	/**
	...
	**/
	...
	/**
		...
		* ERASE (only works when rendering to a framebuffer, like a Render Texture)
		...
		are used.
	**/
	function setBlendMode(value:ts.AnyOf3<String, Float, phaser.BlendModes>):DOMElement;
	/**
	...
	**/
	...
	/**
		...
		This method does not change this Game Objects `depth` value, it simply alters its list position.
	**/
	function setAbove(gameObject:GameObject):DOMElement;
	/**
		...
		This method does not change this Game Objects `depth` value, it simply alters its list position.
	**/
	function setBelow(gameObject:GameObject):DOMElement;
	/**
	...
	**/
	function copyPosition(source:ts.AnyOf3<phaser.types.math.Vector2Like, phaser.types.math.Vector3Like, phaser.types.math.Vector4Like>):DOMElement;
	/**
	...
	**/
	function setData<T>(key:ts.AnyOf2<String, T>, ?data:Dynamic):DOMElement;
	/**
		...
		When the value is first set, a `setdata` event is emitted from this Game Object.
	**/
	function incData(key:String, ?amount:Float):DOMElement;
	/**
		...
		When the value is first set, a `setdata` event is emitted from this Game Object.
	**/
	function toggleData(key:String):DOMElement;
	/**
	...
	**/
	function setInteractive(?hitArea:Dynamic, ?callback:phaser.types.input.HitAreaCallback, ?dropZone:Bool):DOMElement;
	/**
	...
	**/
	function disableInteractive(?resetCursor:Bool):DOMElement;
	/**
	...
	**/
	function removeInteractive(?resetCursor:Bool):DOMElement;
	/**
	...
	**/
	function addToDisplayList(?displayList:ts.AnyOf2<Layer, DisplayList>):DOMElement;
	/**
	...
	**/
	function addToUpdateList():DOMElement;
	/**
		...
		disable it from rendering, consider using the `setVisible` method, instead.
	**/
	function removeFromDisplayList():DOMElement;
	/**
		...
		run animations.
	**/
	function removeFromUpdateList():DOMElement;
	/**
