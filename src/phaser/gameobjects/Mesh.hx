...
@:native("Phaser.GameObjects.Mesh") extern class Mesh extends GameObject {
	function new(scene:phaser.Scene, ?x:Float, ?y:Float, ?texture:ts.AnyOf2<String, phaser.textures.Texture>, ?frame:ts.AnyOf2<String, Float>, ?vertices:Array<Float>, ?uvs:Array<Float>, ?indicies:Array<Float>, ?containsZ:Bool, ?normals:Array<Float>, ?colors:ts.AnyOf2<Float, Array<Float>>, ?alphas:ts.AnyOf2<Float, Array<Float>>);
	/**
	...
	**/
	var modelPosition : phaser.math.Vector3;
	/**
		...
		Changing this property will impact all vertices being rendered by this Mesh.
	**/
	var modelScale : phaser.math.Vector3;
	/**
	...
	**/
	function sortByDepth(faceA:phaser.geom.mesh.Face, faceB:phaser.geom.mesh.Face):Float;
	/**
	...
	**/
	function addFace(vertex1:phaser.geom.mesh.Vertex, vertex2:phaser.geom.mesh.Vertex, vertex3:phaser.geom.mesh.Vertex):Mesh;
	/**
	...
	**/
	function getFace(index:Float):phaser.geom.mesh.Face;
	/**
	...
	**/
	function hasFaceAt(x:Float, y:Float, ?camera:phaser.cameras.scene2d.Camera):Bool;
	/**
	...
	**/
	function getFaceAt(x:Float, y:Float, ?camera:phaser.cameras.scene2d.Camera):Array<phaser.geom.mesh.Face>;
	/**
	...
	**/
	function renderDebug(src:Mesh, faces:Array<phaser.geom.mesh.Face>):Void;
	/**
	...
	**/
	function setInteractive(?config:phaser.types.input.InputConfiguration):Mesh;
	/**
	...
	**/
	function setTint(?tint:Float):Mesh;
	/**
	...
	**/
	function uvScroll(x:Float, y:Float):Mesh;
	/**
	...
	**/
	function uvScale(x:Float, y:Float):Mesh;
	/**
	...
	**/
	...
	/**
		...
		* ERASE (only works when rendering to a framebuffer, like a Render Texture)
		...
		are used.
	**/
	function setBlendMode(value:ts.AnyOf3<String, Float, phaser.BlendModes>):Mesh;
	/**
	...
	**/
	function setMask(mask:ts.AnyOf2<phaser.display.masks.BitmapMask, phaser.display.masks.GeometryMask>):Mesh;
	/**
	...
	**/
	function setPipeline(pipeline:ts.AnyOf2<String, phaser.renderer.webgl.WebGLPipeline>, ?pipelineData:Dynamic, ?copyData:Bool):Mesh;
	/**
	...
	**/
	function setPostPipeline(pipelines:ts.AnyOf6<String, haxe.Constraints.Function, Array<String>, Array<haxe.Constraints.Function>, phaser.renderer.webgl.pipelines.PostFXPipeline, Array<phaser.renderer.webgl.pipelines.PostFXPipeline>>, ?pipelineData:Dynamic, ?copyData:Bool):Mesh;
	/**
		...
		If `value` is undefined, and `key` exists, `key` is removed from the data object.
	**/
	function setPostPipelineData(key:String, ?value:Dynamic):Mesh;
	/**
	...
	**/
	function removePostPipeline(pipeline:ts.AnyOf2<String, phaser.renderer.webgl.pipelines.PostFXPipeline>):Mesh;
	/**
	...
	**/
	function setSizeToFrame(?frame:ts.AnyOf2<Bool, phaser.textures.Frame>):Mesh;
	/**
	...
	**/
	function setTexture(key:ts.AnyOf2<String, phaser.textures.Texture>, ?frame:ts.AnyOf2<String, Float>, ?updateSize:Bool, ?updateOrigin:Bool):Mesh;
	/**
		...
		It will also change the `origin` if the Frame has a custom pivot point, as exported from packages like Texture Packer.
	**/
	function setFrame(frame:ts.AnyOf3<String, Float, phaser.textures.Frame>, ?updateSize:Bool, ?updateOrigin:Bool):Mesh;
	/**
	...
	**/
	function copyPosition(source:ts.AnyOf3<phaser.types.math.Vector2Like, phaser.types.math.Vector3Like, phaser.types.math.Vector4Like>):Mesh;
	/**
	...
	**/
	function setData<T>(key:ts.AnyOf2<String, T>, ?data:Dynamic):Mesh;
	/**
		...
		When the value is first set, a `setdata` event is emitted from this Game Object.
	**/
	function incData(key:String, ?amount:Float):Mesh;
	/**
		...
		When the value is first set, a `setdata` event is emitted from this Game Object.
	**/
	function toggleData(key:String):Mesh;
	/**
	...
	**/
	function addToDisplayList(?displayList:ts.AnyOf2<Layer, DisplayList>):Mesh;
	/**
	...
	**/
	...
	/**
		...
		disable it from rendering, consider using the `setVisible` method, instead.
	**/
	function removeFromDisplayList():Mesh;
	/**
		...
		run animations.
	**/
	function removeFromUpdateList():Mesh;
	/**
