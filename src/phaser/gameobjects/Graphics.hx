...
@:native("Phaser.GameObjects.Graphics") extern class Graphics extends GameObject {
	...
	**/
	...
	/**
		...
		This method does not change this Game Objects `depth` value, it simply alters its list position.
	**/
	function setAbove(gameObject:GameObject):Graphics;
	/**
		...
		This method does not change this Game Objects `depth` value, it simply alters its list position.
	**/
	function setBelow(gameObject:GameObject):Graphics;
	/**
	...
	**/
	function disableInteractive(?resetCursor:Bool):Graphics;
	/**
	...
	**/
	function removeInteractive(?resetCursor:Bool):Graphics;
	/**
