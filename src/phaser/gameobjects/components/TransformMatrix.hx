...
@:native("Phaser.GameObjects.Components.TransformMatrix") extern class TransformMatrix {
	...
	**/
	function transformPoint(x:Float, y:Float, ?point:phaser.types.math.Vector2Like):phaser.types.math.Vector2Like;
	/**
		Invert the Matrix.
	**/
	...
	**/
	function decomposeMatrix():phaser.types.gameobjects.DecomposeMatrixResults;
	/**
	...
	**/
	function applyInverse(x:Float, y:Float, ?output:phaser.math.Vector2):phaser.math.Vector2;
	/**
		...
		from this method.
	**/
	function setQuad(x:Float, y:Float, xw:Float, yh:Float, ?roundPixels:Bool, ?quad:js.lib.Float32Array):js.lib.Float32Array;
	/**
