...
**/
@:native("Phaser.GameObjects.Group") extern class Group extends phaser.events.EventEmitter {
	function new(scene:phaser.Scene, ?children:ts.AnyOf3<Array<GameObject>, phaser.types.gameobjects.group.GroupConfig, phaser.types.gameobjects.group.GroupCreateConfig>, ?config:ts.AnyOf2<phaser.types.gameobjects.group.GroupConfig, phaser.types.gameobjects.group.GroupCreateConfig>);
	/**
	...
	**/
	var children : phaser.structs.Set<GameObject>;
	/**
	...
	**/
	function createMultiple(config:ts.AnyOf2<phaser.types.gameobjects.group.GroupCreateConfig, Array<phaser.types.gameobjects.group.GroupCreateConfig>>):Array<Dynamic>;
	/**
		A helper for {@link Phaser.GameObjects.Group#createMultiple}.
	**/
	function createFromConfig(options:phaser.types.gameobjects.group.GroupCreateConfig):Array<Dynamic>;
	/**
	...
	**/
	function destroy(?destroyChildren:Bool, ?removeFromScene:Bool):Void;
	/**
