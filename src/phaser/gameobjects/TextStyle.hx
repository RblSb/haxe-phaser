...
@:native("Phaser.GameObjects.TextStyle") extern class TextStyle {
	function new(text:Text, style:phaser.types.gameobjects.text.TextStyle);
	/**
	...
	**/
	...
	/**
		The text fill color.
	**/
	var color : ts.AnyOf3<String, js.html.CanvasGradient, js.html.CanvasPattern>;
	/**
		The text stroke color.
	**/
	var stroke : ts.AnyOf3<String, js.html.CanvasGradient, js.html.CanvasPattern>;
	/**
	...
	**/
	@:optional
	dynamic function wordWrapCallback(text:String, textObject:Text):ts.AnyOf2<String, Array<String>>;
	/**
	...
	**/
	...
	/**
		Set the text style.
	**/
	function setStyle(style:phaser.types.gameobjects.text.TextStyle, ?updateText:Bool, ?setDefaults:Bool):Text;
	/**
