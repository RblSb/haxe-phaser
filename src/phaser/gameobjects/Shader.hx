...
@:native("Phaser.GameObjects.Shader") extern class Shader extends GameObject {
	function new(scene:phaser.Scene, key:ts.AnyOf2<String, phaser.display.BaseShader>, ?x:Float, ?y:Float, ?width:Float, ?height:Float, ?textures:Array<String>, ?textureData:Dynamic);
	/**
		The underlying shader object being used.
		Empty by default and set during a call to the `setShader` method.
	**/
	var shader : phaser.display.BaseShader;
	/**
	...
	**/
	var vertexBuffer : phaser.renderer.webgl.wrappers.WebGLBufferWrapper;
	/**
		The WebGL shader program this shader uses.
	**/
	var program : phaser.renderer.webgl.wrappers.WebGLProgramWrapper;
	/**
	...
	**/
	var framebuffer : Null<phaser.renderer.webgl.wrappers.WebGLFramebufferWrapper>;
	/**
	...
	**/
	function setShader(key:ts.AnyOf2<String, phaser.display.BaseShader>, ?textures:Array<String>, ?textureData:Dynamic):Shader;
	/**
	...
	**/
	function setPointer(?pointer:phaser.input.Pointer):Shader;
	/**
	...
	**/
	function setSampler2DBuffer(uniformKey:String, texture:phaser.renderer.webgl.wrappers.WebGLTextureWrapper, width:Float, height:Float, ?textureIndex:Float, ?textureData:Dynamic):Shader;
	/**
	...
	**/
	function load(?matrix2D:phaser.gameobjects.components.TransformMatrix):Void;
	/**
		Called automatically during render.
	...
	**/
	...
	/**
		...
		This method does not change this Game Objects `depth` value, it simply alters its list position.
	**/
	function setAbove(gameObject:GameObject):Shader;
	/**
		...
		This method does not change this Game Objects `depth` value, it simply alters its list position.
	**/
	function setBelow(gameObject:GameObject):Shader;
	/**
	...
	**/
	function setMask(mask:ts.AnyOf2<phaser.display.masks.BitmapMask, phaser.display.masks.GeometryMask>):Shader;
	/**
	...
	**/
	function copyPosition(source:ts.AnyOf3<phaser.types.math.Vector2Like, phaser.types.math.Vector3Like, phaser.types.math.Vector4Like>):Shader;
	/**
	...
	**/
	function setData<T>(key:ts.AnyOf2<String, T>, ?data:Dynamic):Shader;
	/**
		...
		When the value is first set, a `setdata` event is emitted from this Game Object.
	**/
	function incData(key:String, ?amount:Float):Shader;
	/**
		...
		When the value is first set, a `setdata` event is emitted from this Game Object.
	**/
	function toggleData(key:String):Shader;
	/**
	...
	**/
	function setInteractive(?hitArea:Dynamic, ?callback:phaser.types.input.HitAreaCallback, ?dropZone:Bool):Shader;
	/**
	...
	**/
	function disableInteractive(?resetCursor:Bool):Shader;
	/**
	...
	**/
	function removeInteractive(?resetCursor:Bool):Shader;
	/**
	...
	**/
	function addToDisplayList(?displayList:ts.AnyOf2<Layer, DisplayList>):Shader;
	/**
	...
	**/
	function addToUpdateList():Shader;
	/**
		...
		disable it from rendering, consider using the `setVisible` method, instead.
	**/
	function removeFromDisplayList():Shader;
	/**
		...
		run animations.
	**/
	function removeFromUpdateList():Shader;
	/**
