...
@:native("Phaser.GameObjects.Arc") extern class Arc extends Shape {
	function new(scene:phaser.Scene, ?x:Float, ?y:Float, ?radius:Float, ?startAngle:Float, ?endAngle:Float, ?anticlockwise:Bool, ?fillColor:Float, ?fillAlpha:Float);
	/**
	...
	**/
	...
	/**
		...
		* ERASE (only works when rendering to a framebuffer, like a Render Texture)
		...
		are used.
	**/
	function setBlendMode(value:ts.AnyOf3<String, Float, phaser.BlendModes>):Arc;
	/**
	...
	**/
	...
	/**
		...
		This method does not change this Game Objects `depth` value, it simply alters its list position.
	**/
	function setAbove(gameObject:GameObject):Arc;
	/**
		...
		This method does not change this Game Objects `depth` value, it simply alters its list position.
	**/
	function setBelow(gameObject:GameObject):Arc;
	/**
	...
	**/
	function setMask(mask:ts.AnyOf2<phaser.display.masks.BitmapMask, phaser.display.masks.GeometryMask>):Arc;
	/**
	...
	**/
	function setPipeline(pipeline:ts.AnyOf2<String, phaser.renderer.webgl.WebGLPipeline>, ?pipelineData:Dynamic, ?copyData:Bool):Arc;
	/**
	...
	**/
	function setPostPipeline(pipelines:ts.AnyOf6<String, haxe.Constraints.Function, Array<String>, Array<haxe.Constraints.Function>, phaser.renderer.webgl.pipelines.PostFXPipeline, Array<phaser.renderer.webgl.pipelines.PostFXPipeline>>, ?pipelineData:Dynamic, ?copyData:Bool):Arc;
	/**
		...
		If `value` is undefined, and `key` exists, `key` is removed from the data object.
	**/
	function setPostPipelineData(key:String, ?value:Dynamic):Arc;
	/**
		Removes a type of Post Pipeline instances from this Game Object, based on the given name, and destroys them.
		
		If you wish to remove all Post Pipelines use the `resetPostPipeline` method instead.
	**/
	function removePostPipeline(pipeline:ts.AnyOf2<String, phaser.renderer.webgl.pipelines.PostFXPipeline>):Arc;
	/**
	...
	**/
	function copyPosition(source:ts.AnyOf3<phaser.types.math.Vector2Like, phaser.types.math.Vector3Like, phaser.types.math.Vector4Like>):Arc;
	/**
	...
	**/
	function setData<T>(key:ts.AnyOf2<String, T>, ?data:Dynamic):Arc;
	/**
		...
		When the value is first set, a `setdata` event is emitted from this Game Object.
	**/
	function incData(key:String, ?amount:Float):Arc;
	/**
		...
		When the value is first set, a `setdata` event is emitted from this Game Object.
	**/
	function toggleData(key:String):Arc;
	/**
	...
	**/
	function setInteractive(?hitArea:Dynamic, ?callback:phaser.types.input.HitAreaCallback, ?dropZone:Bool):Arc;
	/**
	...
	**/
	function disableInteractive(?resetCursor:Bool):Arc;
	/**
	...
	**/
	function removeInteractive(?resetCursor:Bool):Arc;
	/**
	...
	**/
	function addToDisplayList(?displayList:ts.AnyOf2<Layer, DisplayList>):Arc;
	/**
	...
	**/
	...
	/**
		...
		disable it from rendering, consider using the `setVisible` method, instead.
	**/
	function removeFromDisplayList():Arc;
	/**
		...
		run animations.
	**/
	function removeFromUpdateList():Arc;
	/**
