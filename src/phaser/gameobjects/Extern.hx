...
@:native("Phaser.GameObjects.Extern") extern class Extern extends GameObject {
	...
	**/
	...
	/**
		...
		This method does not change this Game Objects `depth` value, it simply alters its list position.
	**/
	function setAbove(gameObject:GameObject):Extern;
	/**
		...
		This method does not change this Game Objects `depth` value, it simply alters its list position.
	**/
	function setBelow(gameObject:GameObject):Extern;
	/**
	...
	**/
	function disableInteractive(?resetCursor:Bool):Extern;
	/**
	...
	**/
	function removeInteractive(?resetCursor:Bool):Extern;
	/**
