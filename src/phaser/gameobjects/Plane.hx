...
@:native("Phaser.GameObjects.Plane") extern class Plane extends Mesh {
	...
	**/
	...
	/**
		...
		This method does not change this Game Objects `depth` value, it simply alters its list position.
	**/
	function setAbove(gameObject:GameObject):Plane;
	/**
		...
		This method does not change this Game Objects `depth` value, it simply alters its list position.
	**/
	function setBelow(gameObject:GameObject):Plane;
	/**
	...
	**/
	function disableInteractive(?resetCursor:Bool):Plane;
	/**
	...
	**/
	function removeInteractive(?resetCursor:Bool):Plane;
	/**
