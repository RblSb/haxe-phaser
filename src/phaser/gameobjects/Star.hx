...
@:native("Phaser.GameObjects.Star") extern class Star extends Shape {
	function new(scene:phaser.Scene, ?x:Float, ?y:Float, ?points:Float, ?innerRadius:Float, ?outerRadius:Float, ?fillColor:Float, ?fillAlpha:Float);
	/**
	...
	**/
	...
	/**
		...
		* ERASE (only works when rendering to a framebuffer, like a Render Texture)
		...
		are used.
	**/
	function setBlendMode(value:ts.AnyOf3<String, Float, phaser.BlendModes>):Star;
	/**
	...
	**/
	...
	/**
		...
		This method does not change this Game Objects `depth` value, it simply alters its list position.
	**/
	function setAbove(gameObject:GameObject):Star;
	/**
		...
		This method does not change this Game Objects `depth` value, it simply alters its list position.
	**/
	function setBelow(gameObject:GameObject):Star;
	/**
	...
	**/
	function setMask(mask:ts.AnyOf2<phaser.display.masks.BitmapMask, phaser.display.masks.GeometryMask>):Star;
	/**
	...
	**/
	function setPipeline(pipeline:ts.AnyOf2<String, phaser.renderer.webgl.WebGLPipeline>, ?pipelineData:Dynamic, ?copyData:Bool):Star;
	/**
	...
	**/
	function setPostPipeline(pipelines:ts.AnyOf6<String, haxe.Constraints.Function, Array<String>, Array<haxe.Constraints.Function>, phaser.renderer.webgl.pipelines.PostFXPipeline, Array<phaser.renderer.webgl.pipelines.PostFXPipeline>>, ?pipelineData:Dynamic, ?copyData:Bool):Star;
	/**
		...
		If `value` is undefined, and `key` exists, `key` is removed from the data object.
	**/
	function setPostPipelineData(key:String, ?value:Dynamic):Star;
	/**
		Removes a type of Post Pipeline instances from this Game Object, based on the given name, and destroys them.
		
		If you wish to remove all Post Pipelines use the `resetPostPipeline` method instead.
	**/
	function removePostPipeline(pipeline:ts.AnyOf2<String, phaser.renderer.webgl.pipelines.PostFXPipeline>):Star;
	/**
	...
	**/
	function copyPosition(source:ts.AnyOf3<phaser.types.math.Vector2Like, phaser.types.math.Vector3Like, phaser.types.math.Vector4Like>):Star;
	/**
	...
	**/
	function setData<T>(key:ts.AnyOf2<String, T>, ?data:Dynamic):Star;
	/**
		...
		When the value is first set, a `setdata` event is emitted from this Game Object.
	**/
	function incData(key:String, ?amount:Float):Star;
	/**
		...
		When the value is first set, a `setdata` event is emitted from this Game Object.
	**/
	function toggleData(key:String):Star;
	/**
	...
	**/
	function setInteractive(?hitArea:Dynamic, ?callback:phaser.types.input.HitAreaCallback, ?dropZone:Bool):Star;
	/**
	...
	**/
	function disableInteractive(?resetCursor:Bool):Star;
	/**
	...
	**/
	function removeInteractive(?resetCursor:Bool):Star;
	/**
	...
	**/
	function addToDisplayList(?displayList:ts.AnyOf2<Layer, DisplayList>):Star;
	/**
	...
	**/
	...
	/**
		...
		disable it from rendering, consider using the `setVisible` method, instead.
	**/
	function removeFromDisplayList():Star;
	/**
		...
		run animations.
	**/
	function removeFromUpdateList():Star;
	/**
