...
**/
@:native("Phaser.GameObjects.GameObject") extern class GameObject extends phaser.events.EventEmitter {
	function new(scene:phaser.Scene, type:String);
	/**
	...
	**/
	function setData<T>(key:ts.AnyOf2<String, T>, ?data:Dynamic):GameObject;
	/**
		...
		When the value is first set, a `setdata` event is emitted from this Game Object.
	**/
	function incData(key:String, ?amount:Float):GameObject;
	/**
		...
		When the value is first set, a `setdata` event is emitted from this Game Object.
	**/
	function toggleData(key:String):GameObject;
	/**
	...
	**/
	function setInteractive(?hitArea:Dynamic, ?callback:phaser.types.input.HitAreaCallback, ?dropZone:Bool):GameObject;
	/**
	...
	**/
	function addToDisplayList(?displayList:ts.AnyOf2<Layer, DisplayList>):GameObject;
	/**
	...
	**/
	function addToUpdateList():GameObject;
	/**
		...
		disable it from rendering, consider using the `setVisible` method, instead.
	**/
	function removeFromDisplayList():GameObject;
	/**
