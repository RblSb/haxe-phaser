...
@:native("Phaser.GameObjects.RetroFont") @valueModuleOnly extern class RetroFont {
	...
	**/
	static function Parse(scene:phaser.Scene, config:phaser.types.gameobjects.bitmaptext.RetroFontConfig):phaser.types.gameobjects.bitmaptext.BitmapFontData;
	/**
