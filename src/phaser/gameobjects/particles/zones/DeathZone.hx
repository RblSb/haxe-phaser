...
@:native("Phaser.GameObjects.Particles.Zones.DeathZone") extern class DeathZone {
	function new(source:phaser.types.gameobjects.particles.DeathZoneSource, killOnEnter:Bool);
	/**
	...
	**/
	function willKill(particle:phaser.gameobjects.particles.Particle):Bool;
