...
@:native("Phaser.GameObjects.RenderTexture") extern class RenderTexture extends Image {
	...
	**/
	function setToTop():RenderTexture;
	/**
		...
		This method does not change this Game Objects `depth` value, it simply alters its list position.
	**/
	function setToBack():RenderTexture;
	/**
		...
		This method does not change this Game Objects `depth` value, it simply alters its list position.
	**/
	function setAbove(gameObject:GameObject):RenderTexture;
	/**
		...
		This method does not change this Game Objects `depth` value, it simply alters its list position.
	**/
	function setBelow(gameObject:GameObject):RenderTexture;
	/**
	...
	**/
	function disableInteractive(?resetCursor:Bool):RenderTexture;
	/**
	...
	**/
	function removeInteractive(?resetCursor:Bool):RenderTexture;
	/**
