...
@:native("Phaser.GameObjects.TileSprite") extern class TileSprite extends GameObject {
	function new(scene:phaser.Scene, x:Float, y:Float, width:Float, height:Float, textureKey:String, ?frameKey:ts.AnyOf2<String, Float>);
	/**
	...
	**/
	var canvas : Null<js.html.CanvasElement>;
	/**
	...
	**/
	var fillPattern : Null<ts.AnyOf2<js.html.CanvasPattern, phaser.renderer.webgl.wrappers.WebGLTextureWrapper>>;
	/**
	...
	**/
	...
	/**
		...
		* ERASE (only works when rendering to a framebuffer, like a Render Texture)
		...
		are used.
	**/
	function setBlendMode(value:ts.AnyOf3<String, Float, phaser.BlendModes>):TileSprite;
	/**
	...
	**/
	function setCrop(?x:ts.AnyOf2<Float, phaser.geom.Rectangle>, ?y:Float, ?width:Float, ?height:Float):TileSprite;
	/**
	...
	**/
	...
	/**
		...
		This method does not change this Game Objects `depth` value, it simply alters its list position.
	**/
	function setAbove(gameObject:GameObject):TileSprite;
	/**
		...
		This method does not change this Game Objects `depth` value, it simply alters its list position.
	**/
	function setBelow(gameObject:GameObject):TileSprite;
	/**
	...
	**/
	function setMask(mask:ts.AnyOf2<phaser.display.masks.BitmapMask, phaser.display.masks.GeometryMask>):TileSprite;
	/**
	...
	**/
	function setPipeline(pipeline:ts.AnyOf2<String, phaser.renderer.webgl.WebGLPipeline>, ?pipelineData:Dynamic, ?copyData:Bool):TileSprite;
	/**
	...
	**/
	function setPostPipeline(pipelines:ts.AnyOf6<String, haxe.Constraints.Function, Array<String>, Array<haxe.Constraints.Function>, phaser.renderer.webgl.pipelines.PostFXPipeline, Array<phaser.renderer.webgl.pipelines.PostFXPipeline>>, ?pipelineData:Dynamic, ?copyData:Bool):TileSprite;
	/**
		...
		If `value` is undefined, and `key` exists, `key` is removed from the data object.
	**/
	function setPostPipelineData(key:String, ?value:Dynamic):TileSprite;
	/**
	...
	**/
	function removePostPipeline(pipeline:ts.AnyOf2<String, phaser.renderer.webgl.pipelines.PostFXPipeline>):TileSprite;
	/**
	...
	**/
	function copyPosition(source:ts.AnyOf3<phaser.types.math.Vector2Like, phaser.types.math.Vector3Like, phaser.types.math.Vector4Like>):TileSprite;
	/**
	...
	**/
	function setData<T>(key:ts.AnyOf2<String, T>, ?data:Dynamic):TileSprite;
	/**
		...
		When the value is first set, a `setdata` event is emitted from this Game Object.
	**/
	function incData(key:String, ?amount:Float):TileSprite;
	/**
		...
		When the value is first set, a `setdata` event is emitted from this Game Object.
	**/
	function toggleData(key:String):TileSprite;
	/**
	...
	**/
	function setInteractive(?hitArea:Dynamic, ?callback:phaser.types.input.HitAreaCallback, ?dropZone:Bool):TileSprite;
	/**
	...
	**/
	function disableInteractive(?resetCursor:Bool):TileSprite;
	/**
	...
	**/
	function removeInteractive(?resetCursor:Bool):TileSprite;
	/**
	...
	**/
	function addToDisplayList(?displayList:ts.AnyOf2<Layer, DisplayList>):TileSprite;
	/**
	...
	**/
	function addToUpdateList():TileSprite;
	/**
		...
		disable it from rendering, consider using the `setVisible` method, instead.
	**/
	function removeFromDisplayList():TileSprite;
	/**
		...
		run animations.
	**/
	function removeFromUpdateList():TileSprite;
	/**
