...
@:native("Phaser.GameObjects.DynamicBitmapText") extern class DynamicBitmapText extends BitmapText {
	...
	**/
	function setToTop():DynamicBitmapText;
	/**
		...
		This method does not change this Game Objects `depth` value, it simply alters its list position.
	**/
	function setToBack():DynamicBitmapText;
	/**
		...
		This method does not change this Game Objects `depth` value, it simply alters its list position.
	**/
	function setAbove(gameObject:GameObject):DynamicBitmapText;
	/**
		...
		This method does not change this Game Objects `depth` value, it simply alters its list position.
	**/
	function setBelow(gameObject:GameObject):DynamicBitmapText;
	/**
	...
	**/
	function disableInteractive(?resetCursor:Bool):DynamicBitmapText;
	/**
	...
	**/
	function removeInteractive(?resetCursor:Bool):DynamicBitmapText;
	/**
