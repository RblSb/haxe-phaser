...
@:native("Phaser.GameObjects.Grid") extern class Grid extends Shape {
	...
	**/
	...
	/**
		...
		This method does not change this Game Objects `depth` value, it simply alters its list position.
	**/
	function setAbove(gameObject:GameObject):Grid;
	/**
		...
		This method does not change this Game Objects `depth` value, it simply alters its list position.
	**/
	function setBelow(gameObject:GameObject):Grid;
	/**
	...
	**/
	function disableInteractive(?resetCursor:Bool):Grid;
	/**
	...
	**/
	function removeInteractive(?resetCursor:Bool):Grid;
	/**
