...
@:native("Phaser.GameObjects.Bob") extern class Bob {
	...
	**/
	private var frame : phaser.textures.Frame;
	/**
	...
	**/
	function setFrame(?frame:ts.AnyOf3<String, Float, phaser.textures.Frame>):Bob;
	/**
	...
	**/
	function reset(x:Float, y:Float, ?frame:ts.AnyOf3<String, Float, phaser.textures.Frame>):Bob;
	/**
