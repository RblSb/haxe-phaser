...
**/
@:native("Phaser.GameObjects.Layer") extern class Layer extends phaser.structs.List_<GameObject> {
	function new(scene:phaser.Scene, ?children:Array<GameObject>);
	/**
	...
	**/
	var displayList : ts.AnyOf2<Layer, DisplayList>;
	/**
	...
	**/
	var input : Null<phaser.types.input.InteractiveObject>;
	/**
		This property is kept purely so a Layer has the same
		shape as a Game Object. You cannot give a Layer a physics body.
	**/
	var body : Null<ts.AnyOf3<phaser.physics.arcade.Body, phaser.physics.arcade.StaticBody, matterjs.BodyType>>;
	/**
	...
	**/
	function toJSON():phaser.types.gameobjects.JSONGameObject;
	/**
	...
	**/
	function addToDisplayList(?displayList:ts.AnyOf2<Layer, DisplayList>):Layer;
	/**
		...
		disable it from rendering, consider using the `setVisible` method, instead.
	**/
	function removeFromDisplayList():Layer;
	/**
	...
	**/
	...
	/**
		...
		* ERASE (only works when rendering to a framebuffer, like a Render Texture)
		...
		are used.
	**/
	function setBlendMode(value:ts.AnyOf3<String, Float, phaser.BlendModes>):Layer;
	/**
	...
	**/
	function setMask(mask:ts.AnyOf2<phaser.display.masks.BitmapMask, phaser.display.masks.GeometryMask>):Layer;
	/**
	...
	**/
	function setPostPipeline(pipelines:ts.AnyOf6<String, haxe.Constraints.Function, Array<String>, Array<haxe.Constraints.Function>, phaser.renderer.webgl.pipelines.PostFXPipeline, Array<phaser.renderer.webgl.pipelines.PostFXPipeline>>, ?pipelineData:Dynamic, ?copyData:Bool):Layer;
	/**
	...
	**/
	function setPostPipelineData(key:String, ?value:Dynamic):Layer;
	/**
	...
	**/
	function removePostPipeline(pipeline:ts.AnyOf2<String, phaser.renderer.webgl.pipelines.PostFXPipeline>):Layer;
	/**
	...
	**/
	function removeAll(?skipCallback:Bool):Layer;
