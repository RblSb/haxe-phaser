...
@:native("Phaser.Input") @valueModuleOnly extern class Input {
	...
	**/
	static function CreateInteractiveObject(gameObject:phaser.gameobjects.GameObject, hitArea:Dynamic, hitAreaCallback:phaser.types.input.HitAreaCallback):phaser.types.input.InteractiveObject;
	/**
		Creates a new Pixel Perfect Handler function.
		
		Access via `InputPlugin.makePixelPerfect` rather than calling it directly.
	**/
	static function CreatePixelPerfectHandler(textureManager:phaser.textures.TextureManager, alphaTolerance:Float):haxe.Constraints.Function;
	/**
