...
**/
@:native("Phaser.Scale.ScaleManager") extern class ScaleManager extends phaser.events.EventEmitter {
	...
	**/
	var canvasBounds : phaser.geom.Rectangle;
	/**
	...
	**/
	var parentSize : phaser.structs.Size;
	/**
	...
	**/
	var gameSize : phaser.structs.Size;
	/**
	...
	**/
	var displayScale : phaser.math.Vector2;
	/**
	...
	**/
	private function parseConfig(config:phaser.types.core.GameConfig):Void;
	/**
		Determines the parent element of the game canvas, if any, based on the game configuration.
	**/
	function getParent(config:phaser.types.core.GameConfig):Void;
	/**
	...
	**/
	function setSnap(?snapWidth:Float, ?snapHeight:Float):ScaleManager;
	/**
	...
	**/
	function getViewPort(?camera:phaser.cameras.scene2d.Camera, ?out:phaser.geom.Rectangle):phaser.geom.Rectangle;
	/**
