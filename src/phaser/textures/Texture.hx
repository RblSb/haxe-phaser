...
@:native("Phaser.Textures.Texture") extern class Texture {
	function new(manager:TextureManager, key:String, source:ts.AnyOf5<js.html.CanvasElement, phaser.renderer.webgl.wrappers.WebGLTextureWrapper, js.html.ImageElement, Array<js.html.ImageElement>, Array<js.html.CanvasElement>>, ?width:Float, ?height:Float);
	/**
	...
	**/
	function add(name:ts.AnyOf2<String, Float>, sourceIndex:Float, x:Float, y:Float, width:Float, height:Float):Null<Frame>;
	/**
	...
	**/
	function getSourceImage(?name:ts.AnyOf2<String, Float>):ts.AnyOf3<js.html.CanvasElement, phaser.gameobjects.RenderTexture, js.html.ImageElement>;
	/**
