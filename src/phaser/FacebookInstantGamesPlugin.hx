...
**/
@:native("Phaser.FacebookInstantGamesPlugin") extern class FacebookInstantGamesPlugin extends phaser.events.EventEmitter {
	...
	**/
	...
	/**
		...
		This value is populated automatically during boot if the API is supported.
	**/
	var playerPhotoURL : Null<String>;
	/**
	...
	**/
	function getLocale():Null<String>;
	/**
	...
	**/
	function getSDKVersion():Null<String>;
	/**
	...
	**/
	function getPlayerPhotoURL():Null<String>;
	/**
	...
	**/
	function chooseContext(?options:ChooseContextConfig):FacebookInstantGamesPlugin;
	/**
	...
	**/
	function getProduct(productID:String):Null<Product>;
	/**
	...
	**/
	...
	/**
		...
		```
	**/
	function update(cta:String, text:Dynamic, key:String, frame:Null<ts.AnyOf2<String, Float>>, template:String, updateData:Dynamic):FacebookInstantGamesPlugin;
	/**
		...
		```
	**/
	function updateLeaderboard(cta:String, text:Dynamic, key:String, frame:Null<ts.AnyOf2<String, Float>>, template:String, updateData:Dynamic):FacebookInstantGamesPlugin;
	/**
