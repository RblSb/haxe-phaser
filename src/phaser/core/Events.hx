...
@:native("Phaser.Core.Events") @valueModuleOnly extern class Events {
	...
	**/
	static final CONTEXT_LOST : String;
	/**
	...
	**/
	static final SYSTEM_READY : String;
	/**
