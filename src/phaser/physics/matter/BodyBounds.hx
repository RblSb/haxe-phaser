...
@:native("Phaser.Physics.Matter.BodyBounds") extern class BodyBounds {
	...
	**/
	function parseBody(body:phaser.types.physics.matter.MatterBody):Bool;
	/**
	...
	**/
	function getTopLeft(body:phaser.types.physics.matter.MatterBody, ?x:Float, ?y:Float):ts.AnyOf2<Bool, phaser.math.Vector2>;
	/**
		...
		This will return the world coordinate based on the bodies _current_ position and bounds.
	**/
	function getTopCenter(body:phaser.types.physics.matter.MatterBody, ?x:Float, ?y:Float):ts.AnyOf2<Bool, phaser.math.Vector2>;
	/**
		...
		This will return the world coordinate based on the bodies _current_ position and bounds.
	**/
	function getTopRight(body:phaser.types.physics.matter.MatterBody, ?x:Float, ?y:Float):ts.AnyOf2<Bool, phaser.math.Vector2>;
	/**
		...
		This will return the world coordinate based on the bodies _current_ position and bounds.
	**/
	function getLeftCenter(body:phaser.types.physics.matter.MatterBody, ?x:Float, ?y:Float):ts.AnyOf2<Bool, phaser.math.Vector2>;
	/**
		...
		This will return the world coordinate based on the bodies _current_ position and bounds.
	**/
	function getCenter(body:phaser.types.physics.matter.MatterBody, ?x:Float, ?y:Float):ts.AnyOf2<Bool, phaser.math.Vector2>;
	/**
		...
		This will return the world coordinate based on the bodies _current_ position and bounds.
	**/
	function getRightCenter(body:phaser.types.physics.matter.MatterBody, ?x:Float, ?y:Float):ts.AnyOf2<Bool, phaser.math.Vector2>;
	/**
		...
		This will return the world coordinate based on the bodies _current_ position and bounds.
	**/
	function getBottomLeft(body:phaser.types.physics.matter.MatterBody, ?x:Float, ?y:Float):ts.AnyOf2<Bool, phaser.math.Vector2>;
	/**
		...
		This will return the world coordinate based on the bodies _current_ position and bounds.
	**/
	function getBottomCenter(body:phaser.types.physics.matter.MatterBody, ?x:Float, ?y:Float):ts.AnyOf2<Bool, phaser.math.Vector2>;
	/**
		...
		This will return the world coordinate based on the bodies _current_ position and bounds.
	**/
	function getBottomRight(body:phaser.types.physics.matter.MatterBody, ?x:Float, ?y:Float):ts.AnyOf2<Bool, phaser.math.Vector2>;
