...
typedef Friction = {
	...
	**/
	function setFriction(value:Float, ?air:Float, ?fstatic:Float):Friction;
	/**
		Sets a new air resistance for this Game Object's Matter Body.
		A value of 0 means the Body will never slow as it moves through space.
		The higher the value, the faster a Body slows when moving through space.
	**/
	function setFrictionAir(value:Float):Friction;
	/**
	...
	**/
	function setFrictionStatic(value:Float):Friction;
};