...
typedef Collision = {
	...
	**/
	function setCollisionCategory(value:Float):Collision;
	/**
	...
	**/
	function setCollisionGroup(value:Float):Collision;
	/**
	...
	**/
	...
	/**
		...
		to the callback.
	**/
	function setOnCollide(callback:haxe.Constraints.Function):Collision;
	/**
		The callback is sent a `Phaser.Types.Physics.Matter.MatterCollisionData` object.
		...
		to the callback.
	**/
	function setOnCollideEnd(callback:haxe.Constraints.Function):Collision;
	/**
		The callback is sent a `Phaser.Types.Physics.Matter.MatterCollisionData` object.
		...
		to the callback.
	**/
	function setOnCollideActive(callback:haxe.Constraints.Function):Collision;
	/**
		...
		to the callback.
	**/
	function setOnCollideWith(body:ts.AnyOf2<matterjs.Body, Array<matterjs.Body>>, callback:haxe.Constraints.Function):Collision;
};