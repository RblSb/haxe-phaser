...
@:native("Phaser.Physics.Matter.Factory") extern class Factory {
	...
	**/
	function rectangle(x:Float, y:Float, width:Float, height:Float, ?options:phaser.types.physics.matter.MatterBodyConfig):matterjs.BodyType;
	/**
		Creates a new rigid trapezoidal Body and adds it to the World.
	**/
	function trapezoid(x:Float, y:Float, width:Float, height:Float, slope:Float, ?options:phaser.types.physics.matter.MatterBodyConfig):matterjs.BodyType;
	/**
		Creates a new rigid circular Body and adds it to the World.
	**/
	function circle(x:Float, y:Float, radius:Float, ?options:phaser.types.physics.matter.MatterBodyConfig, ?maxSides:Float):matterjs.BodyType;
	/**
		Creates a new rigid polygonal Body and adds it to the World.
	**/
	function polygon(x:Float, y:Float, sides:Float, radius:Float, ?options:phaser.types.physics.matter.MatterBodyConfig):matterjs.BodyType;
	/**
	...
	**/
	function fromVertices(x:Float, y:Float, vertexSets:ts.AnyOf2<String, Array<Dynamic>>, ?options:phaser.types.physics.matter.MatterBodyConfig, ?flagInternal:Bool, ?removeCollinear:Float, ?minimumArea:Float):matterjs.BodyType;
	/**
	...
	**/
	function fromPhysicsEditor(x:Float, y:Float, config:Dynamic, ?options:phaser.types.physics.matter.MatterBodyConfig, ?addToWorld:Bool):matterjs.BodyType;
	/**
		...
		```
	**/
	function fromSVG(x:Float, y:Float, xml:Dynamic, ?scale:Float, ?options:phaser.types.physics.matter.MatterBodyConfig, ?addToWorld:Bool):matterjs.BodyType;
	/**
	...
	**/
	function fromJSON(x:Float, y:Float, config:Dynamic, ?options:phaser.types.physics.matter.MatterBodyConfig, ?addToWorld:Bool):matterjs.BodyType;
	/**
		Create a new composite containing Matter Image objects created in a grid arrangement.
		This function uses the body bounds to prevent overlaps.
	**/
	function imageStack(key:String, frame:ts.AnyOf2<String, Float>, x:Float, y:Float, columns:Float, rows:Float, ?columnGap:Float, ?rowGap:Float, ?options:phaser.types.physics.matter.MatterBodyConfig):matterjs.CompositeType;
	/**
		Create a new composite containing bodies created in the callback in a grid arrangement.
		
		This function uses the body bounds to prevent overlaps.
	**/
	function stack(x:Float, y:Float, columns:Float, rows:Float, columnGap:Float, rowGap:Float, callback:haxe.Constraints.Function):matterjs.CompositeType;
	/**
		Create a new composite containing bodies created in the callback in a pyramid arrangement.
		This function uses the body bounds to prevent overlaps.
	**/
	function pyramid(x:Float, y:Float, columns:Float, rows:Float, columnGap:Float, rowGap:Float, callback:haxe.Constraints.Function):matterjs.CompositeType;
	/**
		Chains all bodies in the given composite together using constraints.
	**/
	function chain(composite:matterjs.CompositeType, xOffsetA:Float, yOffsetA:Float, xOffsetB:Float, yOffsetB:Float, ?options:phaser.types.physics.matter.MatterConstraintConfig):matterjs.CompositeType;
	/**
		Connects bodies in the composite with constraints in a grid pattern, with optional cross braces.
	**/
	function mesh(composite:matterjs.CompositeType, columns:Float, rows:Float, crossBrace:Bool, ?options:phaser.types.physics.matter.MatterConstraintConfig):matterjs.CompositeType;
	/**
		Creates a composite with a Newton's Cradle setup of bodies and constraints.
	**/
	function newtonsCradle(x:Float, y:Float, number:Float, size:Float, length:Float):matterjs.CompositeType;
	/**
		Creates a composite with simple car setup of bodies and constraints.
	**/
	function car(x:Float, y:Float, width:Float, height:Float, wheelSize:Float):matterjs.CompositeType;
	/**
		Creates a simple soft body like object.
	**/
	function softBody(x:Float, y:Float, columns:Float, rows:Float, columnGap:Float, rowGap:Float, crossBrace:Bool, particleRadius:Float, ?particleOptions:phaser.types.physics.matter.MatterBodyConfig, ?constraintOptions:phaser.types.physics.matter.MatterConstraintConfig):matterjs.CompositeType;
	/**
	...
	**/
	function joint(bodyA:matterjs.BodyType, bodyB:matterjs.BodyType, ?length:Float, ?stiffness:Float, ?options:phaser.types.physics.matter.MatterConstraintConfig):matterjs.ConstraintType;
	/**
		This method is an alias for `Factory.constraint`.
		...
		For compound bodies, constraints must be applied to the parent body and not one of its parts.
	**/
	function spring(bodyA:matterjs.BodyType, bodyB:matterjs.BodyType, ?length:Float, ?stiffness:Float, ?options:phaser.types.physics.matter.MatterConstraintConfig):matterjs.ConstraintType;
	/**
		Constraints (or joints) are used for specifying that a fixed distance must be maintained
		between two bodies, or a body and a fixed world-space position.
		...
		For compound bodies, constraints must be applied to the parent body and not one of its parts.
	**/
	function constraint(bodyA:matterjs.BodyType, bodyB:matterjs.BodyType, ?length:Float, ?stiffness:Float, ?options:phaser.types.physics.matter.MatterConstraintConfig):matterjs.ConstraintType;
	/**
		Constraints (or joints) are used for specifying that a fixed distance must be maintained
		between two bodies, or a body and a fixed world-space position.
		...
		For compound bodies, constraints must be applied to the parent body and not one of its parts.
	**/
	function worldConstraint(body:matterjs.BodyType, ?length:Float, ?stiffness:Float, ?options:phaser.types.physics.matter.MatterConstraintConfig):matterjs.ConstraintType;
	/**
	...
	**/
	function mouseSpring(?options:phaser.types.physics.matter.MatterConstraintConfig):matterjs.ConstraintType;
	/**
		A Pointer Constraint is a special type of constraint that allows you to click
		and drag bodies in a Matter World. It monitors the active Pointers in a Scene,
		and when one is pressed down it checks to see if that hit any part of any active
		...
		the `options` object on creation.
	**/
	function pointerConstraint(?options:phaser.types.physics.matter.MatterConstraintConfig):matterjs.ConstraintType;
	/**
	...
	**/
	function image(x:Float, y:Float, key:String, ?frame:ts.AnyOf2<String, Float>, ?options:phaser.types.physics.matter.MatterBodyConfig):Image;
	/**
	...
	**/
	function tileBody(tile:phaser.tilemaps.Tile, ?options:phaser.types.physics.matter.MatterTileOptions):TileBody;
	/**
	...
	**/
	function sprite(x:Float, y:Float, key:String, ?frame:ts.AnyOf2<String, Float>, ?options:phaser.types.physics.matter.MatterBodyConfig):Sprite;
	/**
	...
	**/
	function gameObject(gameObject:phaser.gameobjects.GameObject, ?options:ts.AnyOf2<phaser.types.physics.matter.MatterBodyConfig, matterjs.Body>, ?addToWorld:Bool):ts.AnyOf3<phaser.gameobjects.GameObject, Image, Sprite>;
	/**
