...
@:native("Phaser.Physics.Matter.Events") @valueModuleOnly extern class Events {
	...
	**/
	static final AFTER_REMOVE : String;
	/**
	...
	**/
	static final AFTER_UPDATE : String;
	/**
	...
	**/
	static final BEFORE_ADD : String;
	/**
	...
	**/
	static final BEFORE_REMOVE : String;
	/**
	...
	**/
	static final BEFORE_UPDATE : String;
	/**
	...
	**/
	static final COLLISION_ACTIVE : String;
	/**
	...
	**/
	static final COLLISION_END : String;
	/**
	...
	**/
	static final COLLISION_START : String;
	/**
	...
	**/
	static final SLEEP_START : String;
}