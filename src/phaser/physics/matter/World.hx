...
**/
@:native("Phaser.Physics.Matter.World") extern class World extends phaser.events.EventEmitter {
	function new(scene:phaser.Scene, config:phaser.types.physics.matter.MatterWorldConfig);
	/**
	...
	**/
	var engine : matterjs.Engine;
	/**
		A `World` composite object that will contain all simulated bodies and constraints.
	**/
	var localWorld : matterjs.World;
	/**
		An object containing the 4 wall bodies that bound the physics world.
	**/
	var walls : phaser.types.physics.matter.MatterWalls;
	/**
	...
	**/
	var runner : phaser.types.physics.matter.MatterRunnerConfig;
	/**
	...
	**/
	var debugConfig : phaser.types.physics.matter.MatterDebugConfig;
	/**
	...
	**/
	function setCompositeRenderStyle(composite:matterjs.CompositeType):World;
	/**
	...
	**/
	function setBodyRenderStyle(body:matterjs.BodyType, ?lineColor:Float, ?lineOpacity:Float, ?lineThickness:Float, ?fillColor:Float, ?fillOpacity:Float):World;
	/**
	...
	**/
	function setConstraintRenderStyle(constraint:matterjs.ConstraintType, ?lineColor:Float, ?lineOpacity:Float, ?lineThickness:Float, ?pinSize:Float, ?anchorColor:Float, ?anchorSize:Float):World;
	/**
	...
	**/
	function create(x:Float, y:Float, width:Float, height:Float, options:Dynamic):matterjs.BodyType;
	/**
	...
	**/
	...
	/**
		...
		Triggers `beforeRemove` and `afterRemove` events.
	**/
	function removeConstraint(constraint:ts.AnyOf2<matterjs.ConstraintType, Array<matterjs.ConstraintType>>, ?deep:Bool):World;
	/**
	...
	**/
	function convertTilemapLayer(tilemapLayer:phaser.tilemaps.TilemapLayer, ?options:Dynamic):World;
	/**
	...
	**/
	function convertTiles(tiles:Array<phaser.tilemaps.Tile>, ?options:Dynamic):World;
	/**
	...
	**/
	function renderGrid(grid:matterjs.Grid, graphics:phaser.gameobjects.Graphics, lineColor:Float, lineOpacity:Float):World;
	/**
		...
		you wish to render the Grid to your own Graphics instance.
	**/
	function renderSeparations(pairs:Array<matterjs.Pair>, graphics:phaser.gameobjects.Graphics, lineColor:Float):World;
	/**
		...
		you wish to render the Grid to your own Graphics instance.
	**/
	function renderCollisions(pairs:Array<matterjs.Pair>, graphics:phaser.gameobjects.Graphics, lineColor:Float):World;
	/**
	...
	**/
	function renderBodyBounds(bodies:Array<Dynamic>, graphics:phaser.gameobjects.Graphics, lineColor:Float, lineOpacity:Float):Void;
	/**
		...
		you wish to render bounds to your own Graphics instance.
	**/
	function renderBodyAxes(bodies:Array<Dynamic>, graphics:phaser.gameobjects.Graphics, showAxes:Bool, lineColor:Float, lineOpacity:Float):Void;
	/**
		...
		you wish to render bounds to your own Graphics instance.
	**/
	function renderBodyVelocity(bodies:Array<Dynamic>, graphics:phaser.gameobjects.Graphics, lineColor:Float, lineOpacity:Float, lineThickness:Float):Void;
	/**
	...
	**/
	function renderBody(body:matterjs.BodyType, graphics:phaser.gameobjects.Graphics, showInternalEdges:Bool, ?lineColor:Float, ?lineOpacity:Float, ?lineThickness:Float, ?fillColor:Float, ?fillOpacity:Float):World;
	/**
	...
	**/
	function renderConvexHull(body:matterjs.BodyType, graphics:phaser.gameobjects.Graphics, hullColor:Float, ?lineThickness:Float):World;
	/**
	...
	**/
	function renderConstraint(constraint:matterjs.ConstraintType, graphics:phaser.gameobjects.Graphics, lineColor:Float, lineOpacity:Float, lineThickness:Float, pinSize:Float, anchorColor:Float, anchorSize:Float):World;
	/**
