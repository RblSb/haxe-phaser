...
@:native("Phaser.Physics.Matter.MatterPhysics") extern class MatterPhysics {
	...
	**/
	var config : phaser.types.physics.matter.MatterWorldConfig;
	/**
	...
	**/
	var composite : matterjs.CompositeFactory;
	/**
	...
	**/
	var constraint : matterjs.ConstraintFactory;
	/**
	...
	**/
	var bodies : matterjs.BodiesFactory;
	/**
	...
	**/
	var vector : matterjs.VectorFactory;
	/**
	...
	**/
	var vertices : matterjs.VerticesFactory;
	/**
		A reference to the `Matter.Vertices` module.
		...
		A `Matter.Body` maintains a set of vertices to represent the shape of the object (its convex hull).
	**/
	var verts : matterjs.VerticesFactory;
	/**
	...
	**/
	function containsPoint(body:ts.AnyOf6<phaser.gameobjects.GameObject, matterjs.BodyType, Image, Sprite, TileBody, Array<phaser.types.physics.matter.MatterBody>>, x:Float, y:Float):Bool;
	/**
		...
		transform them before passing them.
	**/
	function intersectPoint(x:Float, y:Float, ?bodies:Array<phaser.types.physics.matter.MatterBody>):Array<phaser.types.physics.matter.MatterBody>;
	/**
		...
		If no bodies are provided it will search all bodies in the Matter World, including within Composites.
	**/
	function intersectRect(x:Float, y:Float, width:Float, height:Float, ?outside:Bool, ?bodies:Array<phaser.types.physics.matter.MatterBody>):Array<phaser.types.physics.matter.MatterBody>;
	/**
	...
	**/
	function intersectRay(x1:Float, y1:Float, x2:Float, y2:Float, ?rayWidth:Float, ?bodies:Array<phaser.types.physics.matter.MatterBody>):Array<phaser.types.physics.matter.MatterBody>;
	/**
	...
	**/
	function intersectBody(body:phaser.types.physics.matter.MatterBody, ?bodies:Array<phaser.types.physics.matter.MatterBody>):Array<phaser.types.physics.matter.MatterBody>;
	/**
	...
	**/
	function overlap(target:ts.AnyOf6<phaser.gameobjects.GameObject, matterjs.BodyType, Image, Sprite, TileBody, Array<phaser.types.physics.matter.MatterBody>>, ?bodies:Array<phaser.types.physics.matter.MatterBody>, ?overlapCallback:phaser.types.physics.arcade.ArcadePhysicsCallback, ?processCallback:phaser.types.physics.arcade.ArcadePhysicsCallback, ?callbackContext:Dynamic):Bool;
	/**
	...
	**/
	function setCollisionCategory(bodies:Array<phaser.types.physics.matter.MatterBody>, value:Float):MatterPhysics;
	/**
	...
	**/
	function setCollisionGroup(bodies:Array<phaser.types.physics.matter.MatterBody>, value:Float):MatterPhysics;
	/**
	...
	**/
	function setCollidesWith(bodies:Array<phaser.types.physics.matter.MatterBody>, categories:ts.AnyOf2<Float, Array<Float>>):MatterPhysics;
	/**
	...
	**/
	function getMatterBodies(?bodies:Array<Dynamic>):Array<matterjs.BodyType>;
	/**
		Sets both the horizontal and vertical linear velocity of the physics bodies.
	**/
	function setVelocity(bodies:ts.AnyOf6<phaser.gameobjects.GameObject, matterjs.BodyType, Image, Sprite, TileBody, Array<phaser.types.physics.matter.MatterBody>>, x:Float, y:Float):MatterPhysics;
	/**
		Sets just the horizontal linear velocity of the physics bodies.
		The vertical velocity of the body is unchanged.
	**/
	function setVelocityX(bodies:ts.AnyOf6<phaser.gameobjects.GameObject, matterjs.BodyType, Image, Sprite, TileBody, Array<phaser.types.physics.matter.MatterBody>>, x:Float):MatterPhysics;
	/**
		Sets just the vertical linear velocity of the physics bodies.
		The horizontal velocity of the body is unchanged.
	**/
	function setVelocityY(bodies:ts.AnyOf6<phaser.gameobjects.GameObject, matterjs.BodyType, Image, Sprite, TileBody, Array<phaser.types.physics.matter.MatterBody>>, y:Float):MatterPhysics;
	/**
		Sets the angular velocity of the bodies instantly.
		Position, angle, force etc. are unchanged.
	**/
	function setAngularVelocity(bodies:ts.AnyOf6<phaser.gameobjects.GameObject, matterjs.BodyType, Image, Sprite, TileBody, Array<phaser.types.physics.matter.MatterBody>>, value:Float):MatterPhysics;
	/**
		Applies a force to a body, at the bodies current position, including resulting torque.
	**/
	function applyForce(bodies:ts.AnyOf6<phaser.gameobjects.GameObject, matterjs.BodyType, Image, Sprite, TileBody, Array<phaser.types.physics.matter.MatterBody>>, force:phaser.types.math.Vector2Like):MatterPhysics;
	/**
	...
	**/
	function applyForceFromPosition(bodies:ts.AnyOf6<phaser.gameobjects.GameObject, matterjs.BodyType, Image, Sprite, TileBody, Array<phaser.types.physics.matter.MatterBody>>, position:phaser.types.math.Vector2Like, speed:Float, ?angle:Float):MatterPhysics;
	/**
		...
		Use very small speed values, such as 0.1, depending on the mass and required velocity.
	**/
	function applyForceFromAngle(bodies:ts.AnyOf6<phaser.gameobjects.GameObject, matterjs.BodyType, Image, Sprite, TileBody, Array<phaser.types.physics.matter.MatterBody>>, speed:Float, ?angle:Float):MatterPhysics;
	/**
		Returns the length of the given constraint, which is the distance between the two points.
	**/
	function getConstraintLength(constraint:matterjs.ConstraintType):Float;
	/**
	...
	**/
	function alignBody(body:phaser.types.physics.matter.MatterBody, x:Float, y:Float, align:Float):MatterPhysics;
