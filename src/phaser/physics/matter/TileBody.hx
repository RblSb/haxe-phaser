...
**/
@:native("Phaser.Physics.Matter.TileBody") extern class TileBody extends phaser.events.EventEmitter {
	function new(world:World, tile:phaser.tilemaps.Tile, ?options:phaser.types.physics.matter.MatterTileOptions);
	/**
	...
	**/
	function setFromTileRectangle(?options:phaser.types.physics.matter.MatterBodyTileOptions):TileBody;
	/**
	...
	**/
	function setFromTileCollision(?options:phaser.types.physics.matter.MatterBodyTileOptions):TileBody;
	/**
		Sets the current body to the given body. This will remove the previous body, if one already
		exists.
	**/
	function setBody(body:matterjs.BodyType, ?addToWorld:Bool):TileBody;
	/**
	...
	**/
	function setBounce(value:Float):TileBody;
	/**
	...
	**/
	function setCollisionCategory(value:Float):TileBody;
	/**
	...
	**/
	function setCollisionGroup(value:Float):TileBody;
	/**
	...
	**/
	function setCollidesWith(categories:ts.AnyOf2<Float, Array<Float>>):TileBody;
	/**
		...
		to the callback.
	**/
	function setOnCollide(callback:haxe.Constraints.Function):TileBody;
	/**
		The callback is sent a `Phaser.Types.Physics.Matter.MatterCollisionData` object.
		...
		to the callback.
	**/
	function setOnCollideEnd(callback:haxe.Constraints.Function):TileBody;
	/**
		The callback is sent a `Phaser.Types.Physics.Matter.MatterCollisionData` object.
		...
		to the callback.
	**/
	function setOnCollideActive(callback:haxe.Constraints.Function):TileBody;
	/**
		...
		to the callback.
	**/
	function setOnCollideWith(body:ts.AnyOf2<matterjs.Body, Array<matterjs.Body>>, callback:haxe.Constraints.Function):TileBody;
	/**
		Sets new friction values for this Game Object's Matter Body.
	**/
	function setFriction(value:Float, ?air:Float, ?fstatic:Float):TileBody;
	/**
		Sets a new air resistance for this Game Object's Matter Body.
		A value of 0 means the Body will never slow as it moves through space.
		The higher the value, the faster a Body slows when moving through space.
	**/
	function setFrictionAir(value:Float):TileBody;
	/**
	...
	**/
	function setFrictionStatic(value:Float):TileBody;
	/**
		A togglable function for ignoring world gravity in real-time on the current body.
	**/
	function setIgnoreGravity(value:Bool):TileBody;
	/**
		Sets the mass of the Game Object's Matter Body.
	**/
	function setMass(value:Float):TileBody;
	/**
		Sets density of the body.
	**/
	function setDensity(value:Float):TileBody;
	/**
	...
	**/
	function setSensor(value:Bool):TileBody;
	/**
	...
	**/
	function setStatic(value:Bool):TileBody;
	/**
