...
@:native("Phaser.Physics.Matter.PointerConstraint") extern class PointerConstraint {
	function new(scene:phaser.Scene, world:World, ?options:Dynamic);
	/**
	...
	**/
	var body : Null<matterjs.BodyType>;
	/**
		The part of the body that was clicked on to start the drag.
	**/
	var part : Null<matterjs.BodyType>;
	/**
	...
	**/
	function onDown(pointer:phaser.input.Pointer):Void;
	/**
	...
	**/
	function hitTestBody(body:matterjs.BodyType, position:phaser.math.Vector2):Bool;
	/**
