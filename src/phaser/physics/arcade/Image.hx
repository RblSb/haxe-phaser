...
**/
@:native("Phaser.Physics.Arcade.Image") extern class Image extends phaser.gameobjects.Image {
	...
	**/
	function setCollideWorldBounds(?value:Bool, ?bounceX:Float, ?bounceY:Float, ?onWorldBounds:Bool):Image;
	/**
	...
	**/
	function setCollisionCategory(category:Float):Image;
	/**
	...
	**/
	function addCollidesWith(category:Float):Image;
	/**
		Removes the given Collision Category from the list of those that this
		Arcade Physics Body will collide with.
	**/
	function removeCollidesWith(category:Float):Image;
	/**
	...
	**/
	function resetCollisionCategory():Image;
	/**
	...
	**/
	function setDirectControl(?value:Bool):Image;
	/**
