...
@:native("Phaser.Physics.Arcade.Sprite") extern class Sprite extends phaser.gameobjects.Sprite {
	...
	**/
	function setCollideWorldBounds(?value:Bool, ?bounceX:Float, ?bounceY:Float, ?onWorldBounds:Bool):Sprite;
	/**
	...
	**/
	function setCollisionCategory(category:Float):Sprite;
	/**
	...
	**/
	function addCollidesWith(category:Float):Sprite;
	/**
		Removes the given Collision Category from the list of those that this
		Arcade Physics Body will collide with.
	**/
	function removeCollidesWith(category:Float):Sprite;
	/**
	...
	**/
	function resetCollisionCategory():Sprite;
	/**
	...
	**/
	function setDirectControl(?value:Bool):Sprite;
	/**
