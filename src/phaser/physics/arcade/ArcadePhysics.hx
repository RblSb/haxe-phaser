...
@:native("Phaser.Physics.Arcade.ArcadePhysics") extern class ArcadePhysics {
	...
	**/
	var config : phaser.types.physics.arcade.ArcadeWorldConfig;
	/**
	...
	**/
	function getConfig():phaser.types.physics.arcade.ArcadeWorldConfig;
	/**
	...
	**/
	function accelerateTo(gameObject:phaser.gameobjects.GameObject, x:Float, y:Float, ?speed:Float, ?xSpeedMax:Float, ?ySpeedMax:Float):Float;
	/**
		Sets the acceleration.x/y property on the game object so it will move towards the x/y coordinates at the given rate (in pixels per second squared)
		...
		Note: The game object doesn't stop moving once it reaches the destination coordinates.
	**/
	function accelerateToObject(gameObject:phaser.gameobjects.GameObject, destination:phaser.gameobjects.GameObject, ?speed:Float, ?xSpeedMax:Float, ?ySpeedMax:Float):Float;
	/**
		...
		is returned.
	**/
	function closest<Target>(source:phaser.types.math.Vector2Like, ?targets:Array<Target>):Null<Target>;
	/**
		...
		is returned.
	**/
	function furthest(source:Dynamic, ?targets:ts.AnyOf3<Array<phaser.gameobjects.GameObject>, Array<Body>, Array<StaticBody>>):Null<ts.AnyOf3<phaser.gameobjects.GameObject, Body, StaticBody>>;
	/**
	...
	**/
	function moveTo(gameObject:phaser.gameobjects.GameObject, x:Float, y:Float, ?speed:Float, ?maxTime:Float):Float;
	/**
		...
		Note: Doesn't take into account acceleration, maxVelocity or drag (if you've set drag or acceleration too high this object may not move at all)
	**/
	function moveToObject(gameObject:phaser.gameobjects.GameObject, destination:Dynamic, ?speed:Float, ?maxTime:Float):Float;
	/**
	...
	**/
	function velocityFromAngle(angle:Float, ?speed:Float, ?vec2:phaser.math.Vector2):phaser.math.Vector2;
	/**
	...
	**/
	function velocityFromRotation(rotation:Float, ?speed:Float, ?vec2:phaser.math.Vector2):phaser.math.Vector2;
	/**
