...
**/
@:native("Phaser.Physics.Arcade.Group") extern class Group extends phaser.gameobjects.Group {
	function new(world:World, scene:phaser.Scene, ?children:ts.AnyOf3<Array<phaser.gameobjects.GameObject>, phaser.types.gameobjects.group.GroupCreateConfig, phaser.types.physics.arcade.PhysicsGroupConfig>, ?config:ts.AnyOf2<phaser.types.gameobjects.group.GroupCreateConfig, phaser.types.physics.arcade.PhysicsGroupConfig>);
	/**
	...
	**/
	var defaults : phaser.types.physics.arcade.PhysicsGroupDefaults;
	/**
	...
	**/
	function setCollisionCategory(category:Float):Group;
	/**
	...
	**/
	function addCollidesWith(category:Float):Group;
	/**
		Removes the given Collision Category from the list of those that this
		Arcade Physics Body will collide with.
	**/
	function removeCollidesWith(category:Float):Group;
	/**
		...
		the `resetCollisionCategory` method.
	**/
	function setCollidesWith(categories:ts.AnyOf2<Float, Array<Float>>):Group;
	/**
		Resets the Collision Category and Mask back to the defaults,
		which is to collide with everything.
	**/
	function resetCollisionCategory():Group;
	/**
		Adds a Game Object to this group.
		
		Calls {@link Phaser.GameObjects.Group#createCallback}.
	**/
	function add(child:phaser.gameobjects.GameObject, ?addToScene:Bool):Group;
	/**
		Adds several Game Objects to this group.
		
		Calls {@link Phaser.GameObjects.Group#createCallback}.
	**/
	function addMultiple(children:Array<phaser.gameobjects.GameObject>, ?addToScene:Bool):Group;
	/**
		Removes a member of this Group and optionally removes it from the Scene and / or destroys it.
		
		Calls {@link Phaser.GameObjects.Group#removeCallback}.
	**/
	function remove(child:phaser.gameobjects.GameObject, ?removeFromScene:Bool, ?destroyChild:Bool):Group;
	/**
	...
	**/
	function rotateAround(point:phaser.types.math.Vector2Like, angle:Float):Group;
	/**
		Rotates each group member around the given point by the given angle and distance.
	**/
	function rotateAroundDistance(point:phaser.types.math.Vector2Like, angle:Float, distance:Float):Group;
	/**
	...
	**/
	function setHitArea(hitArea:Dynamic, hitAreaCallback:phaser.types.input.HitAreaCallback):Group;
	/**
