...
**/
@:native("Phaser.Physics.Arcade.World") extern class World extends phaser.events.EventEmitter {
	function new(scene:phaser.Scene, config:phaser.types.physics.arcade.ArcadeWorldConfig);
	/**
	...
	**/
	var bodies : phaser.structs.Set<Body>;
	/**
		Static Bodies in this simulation.
	**/
	var staticBodies : phaser.structs.Set<StaticBody>;
	/**
		Static Bodies marked for deletion.
	**/
	var pendingDestroy : phaser.structs.Set<ts.AnyOf2<Body, StaticBody>>;
	/**
		This simulation's collision processors.
	**/
	var colliders : phaser.structs.ProcessQueue<Collider>;
	/**
		Acceleration of Bodies due to gravity, in pixels per second.
	**/
	var gravity : phaser.math.Vector2;
	/**
	...
	**/
	var checkCollision : phaser.types.physics.arcade.CheckCollisionObject;
	/**
	...
	**/
	var debugGraphic : phaser.gameobjects.Graphics;
	/**
		Default debug display settings for new Bodies.
	**/
	var defaults : phaser.types.physics.arcade.ArcadeWorldDefaults;
	/**
	...
	**/
	var staticTree : phaser.structs.RTree;
	/**
		Recycled input for tree searches.
	**/
	var treeMinMax : phaser.types.physics.arcade.ArcadeWorldTreeMinMax;
	/**
		The Filtering Options passed to `GetTilesWithinWorldXY` as part of the `collideSpriteVsTilemapLayer` check.
	**/
	var tileFilterOptions : phaser.types.tilemaps.FilteringOptions;
	/**
	...
	**/
	function enable(object:ts.AnyOf4<phaser.gameobjects.GameObject, Array<phaser.gameobjects.GameObject>, phaser.gameobjects.Group, Array<phaser.gameobjects.Group>>, ?bodyType:Float):Void;
	/**
		...
		method to have their bodies created.
	**/
	function enableBody(object:phaser.gameobjects.GameObject, ?bodyType:Float):phaser.gameobjects.GameObject;
	/**
	...
	**/
	function disable(object:ts.AnyOf4<phaser.gameobjects.GameObject, Array<phaser.gameobjects.GameObject>, phaser.gameobjects.Group, Array<phaser.gameobjects.Group>>):Void;
	/**
	...
	**/
	function createDebugGraphic():phaser.gameobjects.Graphics;
	/**
	...
	**/
	function addCollider(object1:phaser.types.physics.arcade.ArcadeColliderType, object2:phaser.types.physics.arcade.ArcadeColliderType, ?collideCallback:phaser.types.physics.arcade.ArcadePhysicsCallback, ?processCallback:phaser.types.physics.arcade.ArcadePhysicsCallback, ?callbackContext:Dynamic):Collider;
	/**
		...
		as it will be handled for you automatically.
	**/
	function addOverlap(object1:phaser.types.physics.arcade.ArcadeColliderType, object2:phaser.types.physics.arcade.ArcadeColliderType, ?collideCallback:phaser.types.physics.arcade.ArcadePhysicsCallback, ?processCallback:phaser.types.physics.arcade.ArcadePhysicsCallback, ?callbackContext:Dynamic):Collider;
	/**
	...
	**/
	function separate(body1:Body, body2:Body, ?processCallback:phaser.types.physics.arcade.ArcadePhysicsCallback, ?callbackContext:Dynamic, ?overlapOnly:Bool):Bool;
	/**
	...
	**/
	function overlap(object1:phaser.types.physics.arcade.ArcadeColliderType, ?object2:phaser.types.physics.arcade.ArcadeColliderType, ?overlapCallback:phaser.types.physics.arcade.ArcadePhysicsCallback, ?processCallback:phaser.types.physics.arcade.ArcadePhysicsCallback, ?callbackContext:Dynamic):Bool;
	/**
	...
	**/
	function collide(object1:phaser.types.physics.arcade.ArcadeColliderType, ?object2:phaser.types.physics.arcade.ArcadeColliderType, ?collideCallback:phaser.types.physics.arcade.ArcadePhysicsCallback, ?processCallback:phaser.types.physics.arcade.ArcadePhysicsCallback, ?callbackContext:Dynamic):Bool;
	/**
		Checks if the two given Arcade Physics bodies will collide, or not,
		based on their collision mask and collision categories.
	**/
	function canCollide(body1:phaser.types.physics.arcade.ArcadeCollider, body2:phaser.types.physics.arcade.ArcadeCollider):Bool;
	/**
	...
	**/
	function collideTiles(sprite:phaser.gameobjects.GameObject, tiles:Array<phaser.tilemaps.Tile>, ?collideCallback:phaser.types.physics.arcade.ArcadePhysicsCallback, ?processCallback:phaser.types.physics.arcade.ArcadePhysicsCallback, ?callbackContext:Dynamic):Bool;
	/**
		...
		This method does not factor in the Collision Mask or Category.
	**/
	function overlapTiles(sprite:phaser.gameobjects.GameObject, tiles:Array<phaser.tilemaps.Tile>, ?collideCallback:phaser.types.physics.arcade.ArcadePhysicsCallback, ?processCallback:phaser.types.physics.arcade.ArcadePhysicsCallback, ?callbackContext:Dynamic):Bool;
	/**
		Internal handler for Sprite vs. Tilemap collisions.
		Please use Phaser.Physics.Arcade.World#collide instead.
	**/
	function collideSpriteVsTilemapLayer(sprite:phaser.gameobjects.GameObject, tilemapLayer:phaser.tilemaps.TilemapLayer, ?collideCallback:phaser.types.physics.arcade.ArcadePhysicsCallback, ?processCallback:phaser.types.physics.arcade.ArcadePhysicsCallback, ?callbackContext:Dynamic, ?overlapOnly:Bool):Bool;
	/**
