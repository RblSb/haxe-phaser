...
@:native("Phaser.Physics.Arcade.Body") extern class Body {
	...
	**/
	var offset : phaser.math.Vector2;
	/**
	...
	**/
	var prev : phaser.math.Vector2;
	/**
		The position of this Body during the previous frame.
	**/
	var prevFrame : phaser.math.Vector2;
	/**
	...
	**/
	final newVelocity : phaser.math.Vector2;
	/**
		The Body's absolute maximum change in position, in pixels per step.
	**/
	var deltaMax : phaser.math.Vector2;
	/**
		The Body's change in velocity, in pixels per second squared.
	**/
	var acceleration : phaser.math.Vector2;
	/**
	...
	**/
	var bounce : phaser.math.Vector2;
	/**
		Rebound following a collision with the world boundary, relative to 1.
		If null, `bounce` is used instead.
	**/
	var worldBounce : Null<phaser.math.Vector2>;
	/**
	...
	**/
	var customBoundsRectangle : phaser.geom.Rectangle;
	/**
	...
	**/
	var maxVelocity : phaser.math.Vector2;
	/**
	...
	**/
	var friction : phaser.math.Vector2;
	/**
	...
	**/
	var slideFactor : phaser.math.Vector2;
	/**
	...
	**/
	function setBoundsRectangle(?bounds:phaser.geom.Rectangle):Body;
	/**
	...
	**/
	function setGameObject(gameObject:phaser.gameobjects.GameObject, ?enable:Bool):Body;
	/**
	...
	**/
	function setDirectControl(?value:Bool):Body;
	/**
	...
	**/
	...
	/**
		...
		can combine this with the `setDrag()` method to create deceleration.
	**/
	function setSlideFactor(x:Float, ?y:Float):Body;
	/**
	...
	**/
	function setCollisionCategory(category:Float):Body;
	/**
	...
	**/
	function addCollidesWith(category:Float):Body;
	/**
		Removes the given Collision Category from the list of those that this
		Arcade Physics Body will collide with.
	**/
	function removeCollidesWith(category:Float):Body;
	/**
		...
		the `resetCollisionCategory` method.
	**/
	function setCollidesWith(categories:ts.AnyOf2<Float, Array<Float>>):Body;
	/**
		Resets the Collision Category and Mask back to the defaults,
		which is to collide with everything.
	**/
	function resetCollisionCategory():Body;
