...
@:native("Phaser.Physics.Arcade") @valueModuleOnly extern class Arcade {
	...
	**/
	static function GetCollidesWith(categories:ts.AnyOf2<Float, Array<Float>>):Float;
	/**
	...
	**/
	static function GetOverlapX(body1:phaser.physics.arcade.Body, body2:phaser.physics.arcade.Body, overlapOnly:Bool, bias:Float):Float;
	/**
	...
	**/
	static function GetOverlapY(body1:phaser.physics.arcade.Body, body2:phaser.physics.arcade.Body, overlapOnly:Bool, bias:Float):Float;
	/**
	...
	**/
	static function SeparateX(body1:phaser.physics.arcade.Body, body2:phaser.physics.arcade.Body, overlapOnly:Bool, bias:Float, ?overlap:Float):Bool;
	/**
	...
	**/
	static function SeparateY(body1:phaser.physics.arcade.Body, body2:phaser.physics.arcade.Body, overlapOnly:Bool, bias:Float, ?overlap:Float):Bool;
	/**
		Either sets or creates the Arcade Body Collision object.
		
		Mostly only used internally.
	**/
	static function SetCollisionObject(noneFlip:Bool, ?data:phaser.types.physics.arcade.ArcadeBodyCollision):phaser.types.physics.arcade.ArcadeBodyCollision;
	/**
		Dynamic Body.
	**/
