...
**/
@:native("Phaser.FacebookInstantGamesLeaderboard") extern class FacebookInstantGamesLeaderboard extends phaser.events.EventEmitter {
	...
	**/
	var playerScore : LeaderboardScore;
	/**
