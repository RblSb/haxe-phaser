...
@:native("Phaser.Scenes.Events") @valueModuleOnly extern class Events {
	...
	**/
	static final POST_UPDATE : String;
	/**
	...
	**/
	static final TRANSITION_COMPLETE : String;
	/**
		...
		5. [TRANSITION_COMPLETE]{@linkcode Phaser.Scenes.Events#event:TRANSITION_COMPLETE} - the Target Scene will emit this event when the transition finishes.
	**/
	static final TRANSITION_INIT : String;
	/**
		...
		5. [TRANSITION_COMPLETE]{@linkcode Phaser.Scenes.Events#event:TRANSITION_COMPLETE} - the Target Scene will emit this event when the transition finishes.
	**/
	static final TRANSITION_OUT : String;
	/**
		...
		5. [TRANSITION_COMPLETE]{@linkcode Phaser.Scenes.Events#event:TRANSITION_COMPLETE} - the Target Scene will emit this event when the transition finishes.
	**/
	static final TRANSITION_START : String;
	/**
		...
		5. [TRANSITION_COMPLETE]{@linkcode Phaser.Scenes.Events#event:TRANSITION_COMPLETE} - the Target Scene will emit this event when the transition finishes.
	**/
	static final TRANSITION_WAKE : String;
	/**
