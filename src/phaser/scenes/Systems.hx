...
@:native("Phaser.Scenes.Systems") extern class Systems {
	function new(scene:phaser.Scene, config:ts.AnyOf2<String, phaser.types.scenes.SettingsConfig>);
	/**
	...
	**/
	var facebook : phaser.FacebookInstantGamesPlugin;
	/**
		The Scene Configuration object, as passed in when creating the Scene.
	**/
	var config : ts.AnyOf2<String, phaser.types.scenes.SettingsConfig>;
	/**
	...
	**/
	private function init(game:phaser.Game):Void;
	/**
