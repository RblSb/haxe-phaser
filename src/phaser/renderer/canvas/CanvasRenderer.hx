...
**/
@:native("Phaser.Renderer.Canvas.CanvasRenderer") extern class CanvasRenderer extends phaser.events.EventEmitter {
	...
	**/
	function snapshotCanvas(canvas:js.html.CanvasElement, callback:phaser.types.renderer.snapshot.SnapshotCallback, ?getPixel:Bool, ?x:Float, ?y:Float, ?width:Float, ?height:Float, ?type:String, ?encoderOptions:Float):CanvasRenderer;
	/**
		...
		more expensive the larger the canvas size gets, so please be careful how you employ this in your game.
	**/
	function snapshot(callback:phaser.types.renderer.snapshot.SnapshotCallback, ?type:String, ?encoderOptions:Float):CanvasRenderer;
	/**
		...
		more expensive the larger the canvas size gets, so please be careful how you employ this in your game.
	**/
	function snapshotArea(x:Float, y:Float, width:Float, height:Float, callback:phaser.types.renderer.snapshot.SnapshotCallback, ?type:String, ?encoderOptions:Float):CanvasRenderer;
	/**
		...
		using less memory.
	**/
	function snapshotPixel(x:Float, y:Float, callback:phaser.types.renderer.snapshot.SnapshotCallback):CanvasRenderer;
	/**
		Takes a Sprite Game Object, or any object that extends it, and draws it to the current context.
	**/
	function batchSprite(sprite:phaser.gameobjects.GameObject, frame:phaser.textures.Frame, camera:phaser.cameras.scene2d.Camera, ?parentTransformMatrix:phaser.gameobjects.components.TransformMatrix):Void;
	/**
