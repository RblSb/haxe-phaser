...
**/
@:native("Phaser.Renderer.WebGL.WebGLPipeline") extern class WebGLPipeline extends phaser.events.EventEmitter {
	...
	**/
	...
	/**
		...
		to the manager.
	**/
	var manager : Null<PipelineManager>;
	/**
	...
	**/
	final vertexBuffer : phaser.renderer.webgl.wrappers.WebGLBufferWrapper;
	/**
		The currently active WebGLBuffer.
	**/
	var activeBuffer : phaser.renderer.webgl.wrappers.WebGLBufferWrapper;
	/**
	...
	**/
	var config : phaser.types.renderer.webgl.WebGLPipelineConfig;
	/**
	...
	**/
	var batch : Array<phaser.types.renderer.webgl.WebGLPipelineBatchEntry>;
	/**
	...
	**/
	var currentBatch : Null<phaser.types.renderer.webgl.WebGLPipelineBatchEntry>;
	/**
		...
		Treat this value as read-only.
	**/
	var currentTexture : Null<phaser.renderer.webgl.wrappers.WebGLTextureWrapper>;
	/**
	...
	**/
	var activeTextures : Array<phaser.renderer.webgl.wrappers.WebGLTextureWrapper>;
	/**
	...
	**/
	function setShader(shader:WebGLShader, ?setAttributes:Bool, ?vertexBuffer:phaser.renderer.webgl.wrappers.WebGLBufferWrapper):WebGLPipeline;
	/**
	...
	**/
	function setShadersFromConfig(config:phaser.types.renderer.webgl.WebGLPipelineConfig):WebGLPipeline;
	/**
		Creates a new WebGL Pipeline Batch Entry, sets the texture unit as zero
		and pushes the entry into the batch.
	**/
	function createBatch(texture:phaser.renderer.webgl.wrappers.WebGLTextureWrapper):Float;
	/**
	...
	**/
	function addTextureToBatch(texture:phaser.renderer.webgl.wrappers.WebGLTextureWrapper):Void;
	/**
		...
		advanced.
	**/
	function pushBatch(texture:phaser.renderer.webgl.wrappers.WebGLTextureWrapper):Float;
	/**
		Custom pipelines can use this method in order to perform any required pre-batch tasks
		for the given Game Object. It must return the texture unit the Game Object was assigned.
	**/
	function setGameObject(gameObject:phaser.gameobjects.GameObject, ?frame:phaser.textures.Frame):Float;
	/**
	...
	**/
	function vertexAvailable():Float;
	/**
	...
	**/
	...
	/**
		...
		them back again.
	**/
	function flipProjectionMatrix(?flipY:Bool):Void;
	/**
	...
	**/
	function rebind(?currentShader:WebGLShader):WebGLPipeline;
	/**
	...
	**/
	...
	/**
		...
		binds itself if not.
	**/
	function setVertexBuffer(?buffer:phaser.renderer.webgl.wrappers.WebGLBufferWrapper):Bool;
	/**
	...
	**/
	function preBatch(?gameObject:ts.AnyOf2<phaser.cameras.scene2d.Camera, phaser.gameobjects.GameObject>):WebGLPipeline;
	/**
	...
	**/
	function postBatch(?gameObject:ts.AnyOf2<phaser.cameras.scene2d.Camera, phaser.gameobjects.GameObject>):WebGLPipeline;
	/**
	...
	**/
	function onDraw(renderTarget:RenderTarget, ?swapTarget:RenderTarget):Void;
	/**
	...
	**/
	function onBind(?gameObject:phaser.gameobjects.GameObject):Void;
	/**
		By default this is an empty method hook that you can override and use in your own custom pipelines.
	...
	**/
	function onBatch(?gameObject:phaser.gameobjects.GameObject):Void;
	/**
		By default this is an empty method hook that you can override and use in your own custom pipelines.
		
		This method is called immediately before a **Game Object** is about to add itself to the batch.
	**/
	function onPreBatch(?gameObject:phaser.gameobjects.GameObject):Void;
	/**
		By default this is an empty method hook that you can override and use in your own custom pipelines.
		
		This method is called immediately after a **Game Object** has been added to the batch.
	**/
	function onPostBatch(?gameObject:phaser.gameobjects.GameObject):Void;
	/**
		By default this is an empty method hook that you can override and use in your own custom pipelines.
	...
	**/
	function onRender(scene:phaser.Scene, camera:phaser.cameras.scene2d.Camera):Void;
	/**
		By default this is an empty method hook that you can override and use in your own custom pipelines.
	...
	**/
	...
	/**
		...
		```
	**/
	function batchTri(gameObject:Null<phaser.gameobjects.GameObject>, x1:Float, y1:Float, x2:Float, y2:Float, x3:Float, y3:Float, u0:Float, v0:Float, u1:Float, v1:Float, tintTL:Float, tintTR:Float, tintBL:Float, tintEffect:ts.AnyOf2<Float, Bool>, ?texture:phaser.renderer.webgl.wrappers.WebGLTextureWrapper, ?unit:Float):Bool;
	/**
	...
	**/
	function drawFillRect(x:Float, y:Float, width:Float, height:Float, color:Float, alpha:Float, ?texture:phaser.renderer.webgl.wrappers.WebGLTextureWrapper, ?flipUV:Bool):Void;
	/**
		Sets the texture to be bound to the next available texture unit and returns
		the unit id.
	**/
	function setTexture2D(?texture:phaser.renderer.webgl.wrappers.WebGLTextureWrapper):Float;
	/**
		Activates the given WebGL Texture and binds it to the requested texture slot.
	**/
	function bindTexture(?target:phaser.renderer.webgl.wrappers.WebGLTextureWrapper, ?unit:Float):WebGLPipeline;
	/**
	...
	**/
	function setTime(name:String, ?shader:WebGLShader):WebGLPipeline;
	/**
		...
		being set.
	**/
	function setBoolean(name:String, value:Bool, ?shader:WebGLShader):WebGLPipeline;
	/**
