...
@:native("Phaser.Renderer.WebGL.WebGLShader") extern class WebGLShader {
	function new(pipeline:WebGLPipeline, name:String, vertexShader:String, fragmentShader:String, attributes:Array<phaser.types.renderer.webgl.WebGLPipelineAttributeConfig>);
	/**
	...
	**/
	var attributes : Array<phaser.types.renderer.webgl.WebGLPipelineAttribute>;
	/**
	...
	**/
	var uniforms : phaser.types.renderer.webgl.WebGLPipelineUniformsConfig;
	/**
	...
	**/
	function createAttributes(attributes:Array<phaser.types.renderer.webgl.WebGLPipelineAttributeConfig>):Void;
	/**
	...
	**/
	function setUniform1(setter:haxe.Constraints.Function, name:String, value1:ts.AnyOf4<Float, Bool, Array<Float>, js.lib.Float32Array>, ?skipCheck:Bool):WebGLShader;
	/**
		Sets the given uniform value/s based on the name and GL function.
		...
		one within the pipeline it belongs to.
	**/
	function setUniform2(setter:haxe.Constraints.Function, name:String, value1:ts.AnyOf4<Float, Bool, Array<Float>, js.lib.Float32Array>, value2:ts.AnyOf4<Float, Bool, Array<Float>, js.lib.Float32Array>, ?skipCheck:Bool):WebGLShader;
	/**
		Sets the given uniform value/s based on the name and GL function.
		...
		one within the pipeline it belongs to.
	**/
	function setUniform3(setter:haxe.Constraints.Function, name:String, value1:ts.AnyOf4<Float, Bool, Array<Float>, js.lib.Float32Array>, value2:ts.AnyOf4<Float, Bool, Array<Float>, js.lib.Float32Array>, value3:ts.AnyOf4<Float, Bool, Array<Float>, js.lib.Float32Array>, ?skipCheck:Bool):WebGLShader;
	/**
		Sets the given uniform value/s based on the name and GL function.
		...
		one within the pipeline it belongs to.
	**/
	function setUniform4(setter:haxe.Constraints.Function, name:String, value1:ts.AnyOf4<Float, Bool, Array<Float>, js.lib.Float32Array>, value2:ts.AnyOf4<Float, Bool, Array<Float>, js.lib.Float32Array>, value3:ts.AnyOf4<Float, Bool, Array<Float>, js.lib.Float32Array>, value4:ts.AnyOf4<Float, Bool, Array<Float>, js.lib.Float32Array>, ?skipCheck:Bool):WebGLShader;
	/**
		...
		one within the pipeline it belongs to.
	**/
	function setBoolean(name:String, value:Bool):WebGLShader;
	/**
	...
	**/
	function createProgram(?vertSrc:String, ?fragSrc:String):WebGLShader;
	/**
