...
@:native("Phaser.Renderer.WebGL.RenderTarget") extern class RenderTarget {
	function new(renderer:WebGLRenderer, width:Float, height:Float, ?scale:Float, ?minFilter:Float, ?autoClear:Bool, ?autoResize:Bool, ?addDepthBuffer:Bool, ?forceClamp:Bool);
	/**
	...
	**/
	var framebuffer : phaser.renderer.webgl.wrappers.WebGLFramebufferWrapper;
	/**
		The WebGLTextureWrapper of this Render Target.
		
		This is created in the `RenderTarget.resize` method.
	**/
	var texture : phaser.renderer.webgl.wrappers.WebGLTextureWrapper;
	/**
	...
	**/
	function willResize(width:Float, height:Float):Bool;
	/**
