...
**/
@:native("Phaser.Renderer.WebGL.Pipelines.BitmapMaskPipeline") extern class BitmapMaskPipeline extends phaser.renderer.webgl.WebGLPipeline {
	function new(config:phaser.types.renderer.webgl.WebGLPipelineConfig);
	/**
		Binds necessary resources and renders the mask to a separated framebuffer.
		The framebuffer for the masked object is also bound for further use.
	**/
	function beginMask(mask:phaser.display.masks.BitmapMask, maskedObject:phaser.gameobjects.GameObject, camera:phaser.cameras.scene2d.Camera):Void;
	/**
	...
	**/
	function endMask(mask:phaser.display.masks.BitmapMask, camera:phaser.cameras.scene2d.Camera, ?renderTarget:phaser.renderer.webgl.RenderTarget):Void;
	/**
		Sets the currently active shader within this pipeline.
	**/
	function setShader(shader:phaser.renderer.webgl.WebGLShader, ?setAttributes:Bool, ?vertexBuffer:phaser.renderer.webgl.wrappers.WebGLBufferWrapper):BitmapMaskPipeline;
	/**
	...
	**/
	function setShadersFromConfig(config:phaser.types.renderer.webgl.WebGLPipelineConfig):BitmapMaskPipeline;
	/**
	...
	**/
	function bind(?currentShader:phaser.renderer.webgl.WebGLShader):BitmapMaskPipeline;
	/**
		This method is called every time the Pipeline Manager rebinds this pipeline.
		
		It resets all shaders this pipeline uses, setting their attributes again.
	**/
	function rebind(?currentShader:phaser.renderer.webgl.WebGLShader):BitmapMaskPipeline;
	/**
	...
	**/
	function preBatch(?gameObject:ts.AnyOf2<phaser.cameras.scene2d.Camera, phaser.gameobjects.GameObject>):BitmapMaskPipeline;
	/**
	...
	**/
	function postBatch(?gameObject:ts.AnyOf2<phaser.cameras.scene2d.Camera, phaser.gameobjects.GameObject>):BitmapMaskPipeline;
	/**
	...
	**/
	function bindTexture(?target:phaser.renderer.webgl.wrappers.WebGLTextureWrapper, ?unit:Float):BitmapMaskPipeline;
	/**
		Activates the given Render Target texture and binds it to the
		requested WebGL texture slot.
	**/
	function bindRenderTarget(?target:phaser.renderer.webgl.RenderTarget, ?unit:Float):BitmapMaskPipeline;
	/**
	...
	**/
	function setTime(name:String, ?shader:phaser.renderer.webgl.WebGLShader):BitmapMaskPipeline;
	/**
		...
		being set.
	**/
	function setBoolean(name:String, value:Bool, ?shader:phaser.renderer.webgl.WebGLShader):BitmapMaskPipeline;
	/**
		...
		being set.
	**/
	function set1f(name:String, x:Float, ?shader:phaser.renderer.webgl.WebGLShader):BitmapMaskPipeline;
	/**
		...
		being set.
	**/
	function set2f(name:String, x:Float, y:Float, ?shader:phaser.renderer.webgl.WebGLShader):BitmapMaskPipeline;
	/**
		...
		being set.
	**/
	function set3f(name:String, x:Float, y:Float, z:Float, ?shader:phaser.renderer.webgl.WebGLShader):BitmapMaskPipeline;
	/**
		...
		being set.
	**/
	function set4f(name:String, x:Float, y:Float, z:Float, w:Float, ?shader:phaser.renderer.webgl.WebGLShader):BitmapMaskPipeline;
	/**
		...
		being set.
	**/
	function set1fv(name:String, arr:ts.AnyOf2<Array<Float>, js.lib.Float32Array>, ?shader:phaser.renderer.webgl.WebGLShader):BitmapMaskPipeline;
	/**
		...
		being set.
	**/
	function set2fv(name:String, arr:ts.AnyOf2<Array<Float>, js.lib.Float32Array>, ?shader:phaser.renderer.webgl.WebGLShader):BitmapMaskPipeline;
	/**
		...
		being set.
	**/
	function set3fv(name:String, arr:ts.AnyOf2<Array<Float>, js.lib.Float32Array>, ?shader:phaser.renderer.webgl.WebGLShader):BitmapMaskPipeline;
	/**
		...
		being set.
	**/
	function set4fv(name:String, arr:ts.AnyOf2<Array<Float>, js.lib.Float32Array>, ?shader:phaser.renderer.webgl.WebGLShader):BitmapMaskPipeline;
	/**
		...
		being set.
	**/
	function set1iv(name:String, arr:ts.AnyOf2<Array<Float>, js.lib.Float32Array>, ?shader:phaser.renderer.webgl.WebGLShader):BitmapMaskPipeline;
	/**
		...
		being set.
	**/
	function set2iv(name:String, arr:ts.AnyOf2<Array<Float>, js.lib.Float32Array>, ?shader:phaser.renderer.webgl.WebGLShader):BitmapMaskPipeline;
	/**
		...
		being set.
	**/
	function set3iv(name:String, arr:ts.AnyOf2<Array<Float>, js.lib.Float32Array>, ?shader:phaser.renderer.webgl.WebGLShader):BitmapMaskPipeline;
	/**
		...
		being set.
	**/
	function set4iv(name:String, arr:ts.AnyOf2<Array<Float>, js.lib.Float32Array>, ?shader:phaser.renderer.webgl.WebGLShader):BitmapMaskPipeline;
	/**
		...
		being set.
	**/
	function set1i(name:String, x:Float, ?shader:phaser.renderer.webgl.WebGLShader):BitmapMaskPipeline;
	/**
		...
		being set.
	**/
	function set2i(name:String, x:Float, y:Float, ?shader:phaser.renderer.webgl.WebGLShader):BitmapMaskPipeline;
	/**
		...
		being set.
	**/
	function set3i(name:String, x:Float, y:Float, z:Float, ?shader:phaser.renderer.webgl.WebGLShader):BitmapMaskPipeline;
	/**
		...
		being set.
	**/
	function set4i(name:String, x:Float, y:Float, z:Float, w:Float, ?shader:phaser.renderer.webgl.WebGLShader):BitmapMaskPipeline;
	/**
		...
		being set.
	**/
	function setMatrix2fv(name:String, transpose:Bool, matrix:ts.AnyOf2<Array<Float>, js.lib.Float32Array>, ?shader:phaser.renderer.webgl.WebGLShader):BitmapMaskPipeline;
	/**
		...
		being set.
	**/
	function setMatrix3fv(name:String, transpose:Bool, matrix:js.lib.Float32Array, ?shader:phaser.renderer.webgl.WebGLShader):BitmapMaskPipeline;
	/**
		...
		being set.
	**/
	function setMatrix4fv(name:String, transpose:Bool, matrix:js.lib.Float32Array, ?shader:phaser.renderer.webgl.WebGLShader):BitmapMaskPipeline;
	/**
