...
**/
@:native("Phaser.Renderer.WebGL.Pipelines.UtilityPipeline") extern class UtilityPipeline extends phaser.renderer.webgl.WebGLPipeline {
	...
	**/
	...
	/**
		...
		This property is set during the `boot` method.
	**/
	var addShader : phaser.renderer.webgl.WebGLShader;
	/**
		A reference to the Linear Blend Shader belonging to this Utility Pipeline.
		
		This property is set during the `boot` method.
	**/
	var linearShader : phaser.renderer.webgl.WebGLShader;
	/**
	...
	**/
	...
	/**
		...
		You can optionally set the brightness factor of the copy.
	**/
	function blitFrame(source:phaser.renderer.webgl.RenderTarget, target:phaser.renderer.webgl.RenderTarget, ?brightness:Float, ?clear:Bool, ?clearAlpha:Bool, ?eraseMode:Bool, ?flipY:Bool):Void;
	/**
	...
	**/
	function drawFrame(source:phaser.renderer.webgl.RenderTarget, ?target:phaser.renderer.webgl.RenderTarget, ?clearAlpha:Bool, ?colorMatrix:phaser.display.ColorMatrix):Void;
	/**
		Draws the `source1` and `source2` Render Targets to the `target` Render Target
		using a linear blend effect, which is controlled by the `strength` parameter.
	**/
	function blendFrames(source1:phaser.renderer.webgl.RenderTarget, source2:phaser.renderer.webgl.RenderTarget, ?target:phaser.renderer.webgl.RenderTarget, ?strength:Float, ?clearAlpha:Bool, ?blendShader:phaser.renderer.webgl.WebGLShader):Void;
	/**
		Draws the `source1` and `source2` Render Targets to the `target` Render Target
	...
	**/
	function setShader(shader:phaser.renderer.webgl.WebGLShader, ?setAttributes:Bool, ?vertexBuffer:phaser.renderer.webgl.wrappers.WebGLBufferWrapper):UtilityPipeline;
	/**
	...
	**/
	function setShadersFromConfig(config:phaser.types.renderer.webgl.WebGLPipelineConfig):UtilityPipeline;
	/**
	...
	**/
	function bind(?currentShader:phaser.renderer.webgl.WebGLShader):UtilityPipeline;
	/**
		This method is called every time the Pipeline Manager rebinds this pipeline.
		
		It resets all shaders this pipeline uses, setting their attributes again.
	**/
	function rebind(?currentShader:phaser.renderer.webgl.WebGLShader):UtilityPipeline;
	/**
	...
	**/
	function preBatch(?gameObject:ts.AnyOf2<phaser.cameras.scene2d.Camera, phaser.gameobjects.GameObject>):UtilityPipeline;
	/**
	...
	**/
	function postBatch(?gameObject:ts.AnyOf2<phaser.cameras.scene2d.Camera, phaser.gameobjects.GameObject>):UtilityPipeline;
	/**
	...
	**/
	function bindTexture(?target:phaser.renderer.webgl.wrappers.WebGLTextureWrapper, ?unit:Float):UtilityPipeline;
	/**
		Activates the given Render Target texture and binds it to the
		requested WebGL texture slot.
	**/
	function bindRenderTarget(?target:phaser.renderer.webgl.RenderTarget, ?unit:Float):UtilityPipeline;
	/**
	...
	**/
	function setTime(name:String, ?shader:phaser.renderer.webgl.WebGLShader):UtilityPipeline;
	/**
		...
		being set.
	**/
	function setBoolean(name:String, value:Bool, ?shader:phaser.renderer.webgl.WebGLShader):UtilityPipeline;
	/**
		...
		being set.
	**/
	function set1f(name:String, x:Float, ?shader:phaser.renderer.webgl.WebGLShader):UtilityPipeline;
	/**
		...
		being set.
	**/
	function set2f(name:String, x:Float, y:Float, ?shader:phaser.renderer.webgl.WebGLShader):UtilityPipeline;
	/**
		...
		being set.
	**/
	function set3f(name:String, x:Float, y:Float, z:Float, ?shader:phaser.renderer.webgl.WebGLShader):UtilityPipeline;
	/**
		...
		being set.
	**/
	function set4f(name:String, x:Float, y:Float, z:Float, w:Float, ?shader:phaser.renderer.webgl.WebGLShader):UtilityPipeline;
	/**
		...
		being set.
	**/
	function set1fv(name:String, arr:ts.AnyOf2<Array<Float>, js.lib.Float32Array>, ?shader:phaser.renderer.webgl.WebGLShader):UtilityPipeline;
	/**
		...
		being set.
	**/
	function set2fv(name:String, arr:ts.AnyOf2<Array<Float>, js.lib.Float32Array>, ?shader:phaser.renderer.webgl.WebGLShader):UtilityPipeline;
	/**
		...
		being set.
	**/
	function set3fv(name:String, arr:ts.AnyOf2<Array<Float>, js.lib.Float32Array>, ?shader:phaser.renderer.webgl.WebGLShader):UtilityPipeline;
	/**
		...
		being set.
	**/
	function set4fv(name:String, arr:ts.AnyOf2<Array<Float>, js.lib.Float32Array>, ?shader:phaser.renderer.webgl.WebGLShader):UtilityPipeline;
	/**
		...
		being set.
	**/
	function set1iv(name:String, arr:ts.AnyOf2<Array<Float>, js.lib.Float32Array>, ?shader:phaser.renderer.webgl.WebGLShader):UtilityPipeline;
	/**
		...
		being set.
	**/
	function set2iv(name:String, arr:ts.AnyOf2<Array<Float>, js.lib.Float32Array>, ?shader:phaser.renderer.webgl.WebGLShader):UtilityPipeline;
	/**
		...
		being set.
	**/
	function set3iv(name:String, arr:ts.AnyOf2<Array<Float>, js.lib.Float32Array>, ?shader:phaser.renderer.webgl.WebGLShader):UtilityPipeline;
	/**
		...
		being set.
	**/
	function set4iv(name:String, arr:ts.AnyOf2<Array<Float>, js.lib.Float32Array>, ?shader:phaser.renderer.webgl.WebGLShader):UtilityPipeline;
	/**
		...
		being set.
	**/
	function set1i(name:String, x:Float, ?shader:phaser.renderer.webgl.WebGLShader):UtilityPipeline;
	/**
		...
		being set.
	**/
	function set2i(name:String, x:Float, y:Float, ?shader:phaser.renderer.webgl.WebGLShader):UtilityPipeline;
	/**
		...
		being set.
	**/
	function set3i(name:String, x:Float, y:Float, z:Float, ?shader:phaser.renderer.webgl.WebGLShader):UtilityPipeline;
	/**
		...
		being set.
	**/
	function set4i(name:String, x:Float, y:Float, z:Float, w:Float, ?shader:phaser.renderer.webgl.WebGLShader):UtilityPipeline;
	/**
		...
		being set.
	**/
	function setMatrix2fv(name:String, transpose:Bool, matrix:ts.AnyOf2<Array<Float>, js.lib.Float32Array>, ?shader:phaser.renderer.webgl.WebGLShader):UtilityPipeline;
	/**
		...
		being set.
	**/
	function setMatrix3fv(name:String, transpose:Bool, matrix:js.lib.Float32Array, ?shader:phaser.renderer.webgl.WebGLShader):UtilityPipeline;
	/**
		...
		being set.
	**/
	function setMatrix4fv(name:String, transpose:Bool, matrix:js.lib.Float32Array, ?shader:phaser.renderer.webgl.WebGLShader):UtilityPipeline;
	/**
