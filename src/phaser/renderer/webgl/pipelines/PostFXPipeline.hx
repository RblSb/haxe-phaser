...
**/
@:native("Phaser.Renderer.WebGL.Pipelines.PostFXPipeline") extern class PostFXPipeline extends phaser.renderer.webgl.WebGLPipeline {
	...
	**/
	var gameObject : ts.AnyOf2<phaser.cameras.scene2d.Camera, phaser.gameobjects.GameObject>;
	/**
		If this Post Pipeline belongs to an FX Controller, this is a
		reference to it.
	**/
	var controller : phaser.fx.Controller;
	/**
		A Color Matrix instance belonging to this pipeline.
		
		Used during calls to the `drawFrame` method.
	**/
	var colorMatrix : phaser.display.ColorMatrix;
	/**
	...
	**/
	var fullFrame1 : phaser.renderer.webgl.RenderTarget;
	/**
		...
		However, be aware that these targets are shared between all post fx pipelines.
	**/
	var fullFrame2 : phaser.renderer.webgl.RenderTarget;
	/**
		...
		However, be aware that these targets are shared between all post fx pipelines.
	**/
	var halfFrame1 : phaser.renderer.webgl.RenderTarget;
	/**
		...
		However, be aware that these targets are shared between all post fx pipelines.
	**/
	var halfFrame2 : phaser.renderer.webgl.RenderTarget;
	/**
	...
	**/
	function postBatch(?gameObject:ts.AnyOf2<phaser.cameras.scene2d.Camera, phaser.gameobjects.GameObject>):PostFXPipeline;
	/**
		Returns the FX Controller for this Post FX Pipeline.
		
		This is called internally and not typically required outside.
	**/
	function getController(?controller:phaser.fx.Controller):ts.AnyOf2<PostFXPipeline, phaser.fx.Controller>;
	/**
	...
	**/
	function copySprite(source:phaser.renderer.webgl.RenderTarget, target:phaser.renderer.webgl.RenderTarget):Void;
	/**
		Copy the `source` Render Target to the `target` Render Target.
	...
	**/
	function copyFrame(source:phaser.renderer.webgl.RenderTarget, ?target:phaser.renderer.webgl.RenderTarget, ?brightness:Float, ?clear:Bool, ?clearAlpha:Bool):Void;
	/**
	...
	**/
	function drawFrame(source:phaser.renderer.webgl.RenderTarget, ?target:phaser.renderer.webgl.RenderTarget, ?clearAlpha:Bool):Void;
	/**
	...
	**/
	function clearFrame(target:phaser.renderer.webgl.RenderTarget, ?clearAlpha:Bool):Void;
	/**
		Copy the `source` Render Target to the `target` Render Target.
		...
		You can optionally set the brightness factor of the copy.
	**/
	function blitFrame(source:phaser.renderer.webgl.RenderTarget, target:phaser.renderer.webgl.RenderTarget, ?brightness:Float, ?clear:Bool, ?clearAlpha:Bool, ?eraseMode:Bool):Void;
	/**
		...
		place.
	**/
	function copyFrameRect(source:phaser.renderer.webgl.RenderTarget, target:phaser.renderer.webgl.RenderTarget, x:Float, y:Float, width:Float, height:Float, ?clear:Bool, ?clearAlpha:Bool):Void;
	/**
	...
	**/
	function bindAndDraw(source:phaser.renderer.webgl.RenderTarget, ?target:phaser.renderer.webgl.RenderTarget, ?clear:Bool, ?clearAlpha:Bool, ?currentShader:phaser.renderer.webgl.WebGLShader):Void;
	/**
	...
	**/
	function setShader(shader:phaser.renderer.webgl.WebGLShader, ?setAttributes:Bool, ?vertexBuffer:phaser.renderer.webgl.wrappers.WebGLBufferWrapper):PostFXPipeline;
	/**
	...
	**/
	function setShadersFromConfig(config:phaser.types.renderer.webgl.WebGLPipelineConfig):PostFXPipeline;
	/**
	...
	**/
	function bind(?currentShader:phaser.renderer.webgl.WebGLShader):PostFXPipeline;
	/**
		This method is called every time the Pipeline Manager rebinds this pipeline.
		
		It resets all shaders this pipeline uses, setting their attributes again.
	**/
	function rebind(?currentShader:phaser.renderer.webgl.WebGLShader):PostFXPipeline;
	/**
	...
	**/
	function preBatch(?gameObject:ts.AnyOf2<phaser.cameras.scene2d.Camera, phaser.gameobjects.GameObject>):PostFXPipeline;
	/**
	...
	**/
	function bindTexture(?target:phaser.renderer.webgl.wrappers.WebGLTextureWrapper, ?unit:Float):PostFXPipeline;
	/**
		Activates the given Render Target texture and binds it to the
		requested WebGL texture slot.
	**/
	function bindRenderTarget(?target:phaser.renderer.webgl.RenderTarget, ?unit:Float):PostFXPipeline;
	/**
	...
	**/
	function setTime(name:String, ?shader:phaser.renderer.webgl.WebGLShader):PostFXPipeline;
	/**
		...
		being set.
	**/
	function setBoolean(name:String, value:Bool, ?shader:phaser.renderer.webgl.WebGLShader):PostFXPipeline;
	/**
		...
		being set.
	**/
	function set1f(name:String, x:Float, ?shader:phaser.renderer.webgl.WebGLShader):PostFXPipeline;
	/**
		...
		being set.
	**/
	function set2f(name:String, x:Float, y:Float, ?shader:phaser.renderer.webgl.WebGLShader):PostFXPipeline;
	/**
		...
		being set.
	**/
	function set3f(name:String, x:Float, y:Float, z:Float, ?shader:phaser.renderer.webgl.WebGLShader):PostFXPipeline;
	/**
		...
		being set.
	**/
	function set4f(name:String, x:Float, y:Float, z:Float, w:Float, ?shader:phaser.renderer.webgl.WebGLShader):PostFXPipeline;
	/**
		...
		being set.
	**/
	function set1fv(name:String, arr:ts.AnyOf2<Array<Float>, js.lib.Float32Array>, ?shader:phaser.renderer.webgl.WebGLShader):PostFXPipeline;
	/**
		...
		being set.
	**/
	function set2fv(name:String, arr:ts.AnyOf2<Array<Float>, js.lib.Float32Array>, ?shader:phaser.renderer.webgl.WebGLShader):PostFXPipeline;
	/**
		...
		being set.
	**/
	function set3fv(name:String, arr:ts.AnyOf2<Array<Float>, js.lib.Float32Array>, ?shader:phaser.renderer.webgl.WebGLShader):PostFXPipeline;
	/**
		...
		being set.
	**/
	function set4fv(name:String, arr:ts.AnyOf2<Array<Float>, js.lib.Float32Array>, ?shader:phaser.renderer.webgl.WebGLShader):PostFXPipeline;
	/**
		...
		being set.
	**/
	function set1iv(name:String, arr:ts.AnyOf2<Array<Float>, js.lib.Float32Array>, ?shader:phaser.renderer.webgl.WebGLShader):PostFXPipeline;
	/**
		...
		being set.
	**/
	function set2iv(name:String, arr:ts.AnyOf2<Array<Float>, js.lib.Float32Array>, ?shader:phaser.renderer.webgl.WebGLShader):PostFXPipeline;
	/**
		...
		being set.
	**/
	function set3iv(name:String, arr:ts.AnyOf2<Array<Float>, js.lib.Float32Array>, ?shader:phaser.renderer.webgl.WebGLShader):PostFXPipeline;
	/**
		...
		being set.
	**/
	function set4iv(name:String, arr:ts.AnyOf2<Array<Float>, js.lib.Float32Array>, ?shader:phaser.renderer.webgl.WebGLShader):PostFXPipeline;
	/**
		...
		being set.
	**/
	function set1i(name:String, x:Float, ?shader:phaser.renderer.webgl.WebGLShader):PostFXPipeline;
	/**
		...
		being set.
	**/
	function set2i(name:String, x:Float, y:Float, ?shader:phaser.renderer.webgl.WebGLShader):PostFXPipeline;
	/**
		...
		being set.
	**/
	function set3i(name:String, x:Float, y:Float, z:Float, ?shader:phaser.renderer.webgl.WebGLShader):PostFXPipeline;
	/**
		...
		being set.
	**/
	function set4i(name:String, x:Float, y:Float, z:Float, w:Float, ?shader:phaser.renderer.webgl.WebGLShader):PostFXPipeline;
	/**
		...
		being set.
	**/
	function setMatrix2fv(name:String, transpose:Bool, matrix:ts.AnyOf2<Array<Float>, js.lib.Float32Array>, ?shader:phaser.renderer.webgl.WebGLShader):PostFXPipeline;
	/**
		...
		being set.
	**/
	function setMatrix3fv(name:String, transpose:Bool, matrix:js.lib.Float32Array, ?shader:phaser.renderer.webgl.WebGLShader):PostFXPipeline;
	/**
		...
		being set.
	**/
	function setMatrix4fv(name:String, transpose:Bool, matrix:js.lib.Float32Array, ?shader:phaser.renderer.webgl.WebGLShader):PostFXPipeline;
	/**
