...
@:native("Phaser.Math.Angle") @valueModuleOnly extern class Angle {
	...
	**/
	static function BetweenPoints(point1:phaser.types.math.Vector2Like, point2:phaser.types.math.Vector2Like):Float;
	/**
		Find the angle of a segment from (point1.x, point1.y) -> (point2.x, point2.y).
	...
	**/
	static function BetweenPointsY(point1:phaser.types.math.Vector2Like, point2:phaser.types.math.Vector2Like):Float;
	/**
		Find the angle of a segment from (x1, y1) -> (x2, y2).
