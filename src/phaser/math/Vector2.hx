...
@:native("Phaser.Math.Vector2") extern class Vector2 {
	function new(?x:ts.AnyOf2<Float, phaser.types.math.Vector2Like>, ?y:Float);
	/**
	...
	**/
	function copy(src:phaser.types.math.Vector2Like):Vector2;
	/**
		Set the component values of this Vector from a given Vector2Like object.
	**/
	function setFromObject(obj:phaser.types.math.Vector2Like):Vector2;
	/**
	...
	**/
	function equals(v:phaser.types.math.Vector2Like):Bool;
	/**
		Check whether this Vector is approximately equal to a given Vector.
	**/
	function fuzzyEquals(v:phaser.types.math.Vector2Like, ?epsilon:Float):Bool;
	/**
	...
	**/
	function add(src:phaser.types.math.Vector2Like):Vector2;
	/**
		Subtract the given Vector from this Vector. Subtraction is component-wise.
	**/
	function subtract(src:phaser.types.math.Vector2Like):Vector2;
	/**
		Perform a component-wise multiplication between this Vector and the given Vector.
		
		Multiplies this Vector by the given Vector.
	**/
	function multiply(src:phaser.types.math.Vector2Like):Vector2;
	/**
	...
	**/
	function divide(src:phaser.types.math.Vector2Like):Vector2;
	/**
	...
	**/
	function distance(src:phaser.types.math.Vector2Like):Float;
	/**
		Calculate the distance between this Vector and the given Vector, squared.
	**/
	function distanceSq(src:phaser.types.math.Vector2Like):Float;
	/**
	...
	**/
	function dot(src:phaser.types.math.Vector2Like):Float;
	/**
		Calculate the cross product of this Vector and the given Vector.
	**/
	function cross(src:phaser.types.math.Vector2Like):Float;
	/**
		Linearly interpolate between this Vector and the given Vector.
		
		Interpolates this Vector towards the given Vector.
	**/
	function lerp(src:phaser.types.math.Vector2Like, ?t:Float):Vector2;
	/**
	...
	**/
	function project(src:Vector2):Vector2;
