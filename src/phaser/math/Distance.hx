...
@:native("Phaser.Math.Distance") @valueModuleOnly extern class Distance {
	...
	**/
	static function BetweenPoints(a:phaser.types.math.Vector2Like, b:phaser.types.math.Vector2Like):Float;
	/**
		Calculate the squared distance between two points.
	**/
	static function BetweenPointsSquared(a:phaser.types.math.Vector2Like, b:phaser.types.math.Vector2Like):Float;
	/**
