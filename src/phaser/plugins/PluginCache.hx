...
@:native("Phaser.Plugins.PluginCache") @valueModuleOnly extern class PluginCache {
	...
	**/
	static function getCore(key:String):phaser.types.plugins.CorePluginContainer;
	/**
		Returns the custom plugin object from the cache based on the given key.
	**/
	static function getCustom(key:String):phaser.types.plugins.CustomPluginContainer;
	/**
