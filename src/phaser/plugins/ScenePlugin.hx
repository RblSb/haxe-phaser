...
@:native("Phaser.Plugins.ScenePlugin") extern class ScenePlugin extends BasePlugin {
	function new(scene:phaser.Scene, pluginManager:PluginManager, pluginKey:String);
	/**
	...
	**/
	private var scene : Null<phaser.Scene>;
	/**
		...
		You can use it during the `boot` method.
	**/
	private var systems : Null<phaser.scenes.Systems>;
	/**
