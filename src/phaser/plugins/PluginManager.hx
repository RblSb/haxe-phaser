...
@:native("Phaser.Plugins.PluginManager") extern class PluginManager {
	...
	**/
	var plugins : Array<phaser.types.plugins.GlobalPlugin>;
	/**
	...
	**/
	private function addToScene(sys:phaser.scenes.Systems, globalPlugins:Array<Dynamic>, scenePlugins:Array<Dynamic>):Void;
	/**
	...
	**/
	function installScenePlugin(key:String, plugin:haxe.Constraints.Function, ?mapping:String, ?addToScene:phaser.Scene, ?fromLoader:Bool):Void;
	/**
	...
	**/
	function install(key:String, plugin:haxe.Constraints.Function, ?start:Bool, ?mapping:String, ?data:Dynamic):Null<BasePlugin>;
	/**
	...
	**/
	private function getEntry(key:String):phaser.types.plugins.GlobalPlugin;
	/**
	...
	**/
	function start(key:String, ?runAs:String):Null<BasePlugin>;
	/**
	...
	**/
	function get(key:String, ?autoStart:Bool):Null<ts.AnyOf2<haxe.Constraints.Function, BasePlugin>>;
	/**
	...
	**/
	function registerFileType(key:String, callback:haxe.Constraints.Function, ?addToScene:phaser.Scene):Void;
	/**
