...
@:native("Phaser.Geom.Line") extern class Line {
	...
	**/
	function setFromObjects(start:phaser.types.math.Vector2Like, end:phaser.types.math.Vector2Like):Line;
	/**
	...
	**/
	static function BresenhamPoints(line:Line, ?stepRate:Float, ?results:Array<phaser.types.math.Vector2Like>):Array<phaser.types.math.Vector2Like>;
	/**
	...
	**/
	static function GetShortestDistance(line:Line, point:phaser.types.math.Vector2Like):ts.AnyOf2<Float, Bool>;
	/**
