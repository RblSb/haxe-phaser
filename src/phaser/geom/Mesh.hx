...
@:native("Phaser.Geom.Mesh") @valueModuleOnly extern class Mesh {
	...
	**/
	static function GenerateGridVerts(config:phaser.types.geom.mesh.GenerateGridConfig):phaser.types.geom.mesh.GenerateGridVertsResult;
	/**
	...
	**/
	static function GenerateObjVerts(data:phaser.types.geom.mesh.OBJData, ?mesh:phaser.gameobjects.Mesh, ?scale:Float, ?x:Float, ?y:Float, ?z:Float, ?rotateX:Float, ?rotateY:Float, ?rotateZ:Float, ?zIsUp:Bool):phaser.types.geom.mesh.GenerateVertsResult;
	/**
	...
	**/
	static function GenerateVerts(vertices:Array<Float>, uvs:Array<Float>, ?indicies:Array<Float>, ?containsZ:Bool, ?normals:Array<Float>, ?colors:ts.AnyOf2<Float, Array<Float>>, ?alphas:ts.AnyOf2<Float, Array<Float>>, ?flipUV:Bool):phaser.types.geom.mesh.GenerateVertsResult;
	/**
	...
	**/
	static function ParseObj(data:String, ?flipUV:Bool):phaser.types.geom.mesh.OBJData;
	/**
	...
	**/
	static function RotateFace(face:phaser.geom.mesh.Face, angle:Float, ?cx:Float, ?cy:Float):Void;
}