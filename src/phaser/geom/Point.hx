...
@:native("Phaser.Geom.Point") extern class Point {
	...
	**/
	static function GetCentroid<O>(points:Array<phaser.types.math.Vector2Like>, ?out:O):O;
	/**
	...
	**/
	static function GetRectangleFromPoints<O>(points:Array<phaser.types.math.Vector2Like>, ?out:O):O;
	/**
