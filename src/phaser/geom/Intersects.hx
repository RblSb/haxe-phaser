...
@:native("Phaser.Geom.Intersects") @valueModuleOnly extern class Intersects {
	...
	**/
	static function GetLineToLine(line1:Line, line2:Line, ?isRay:Bool, ?out:phaser.math.Vector3):phaser.math.Vector3;
	/**
	...
	**/
	static function GetLineToPoints(line:Line, points:ts.AnyOf2<Array<Point>, Array<phaser.math.Vector2>>, ?isRay:Bool, ?out:phaser.math.Vector3):phaser.math.Vector3;
	/**
	...
	**/
	static function GetLineToPolygon(line:Line, polygons:ts.AnyOf2<Polygon, Array<Polygon>>, ?isRay:Bool, ?out:phaser.math.Vector4):phaser.math.Vector4;
	/**
	...
	**/
	...
	/**
		...
		The `w` component contains the index of the polygon, in the given array, that triggered the intersection.
	**/
	static function GetRaysFromPointToPolygon(x:Float, y:Float, polygons:ts.AnyOf2<Polygon, Array<Polygon>>):Array<phaser.math.Vector4>;
	/**
	...
	**/
	static function LineToLine(line1:Line, line2:Line, ?out:phaser.types.math.Vector2Like):Bool;
	/**
