...
@:native("Phaser.Math") @valueModuleOnly extern class Math_ {
	...
	**/
	static function LinearXY(vector1:phaser.math.Vector2, vector2:phaser.math.Vector2, ?t:Float):phaser.math.Vector2;
	/**
	...
	**/
	static function RandomXY(vector:phaser.math.Vector2, ?scale:Float):phaser.math.Vector2;
	/**
		Compute a random position vector in a spherical area, optionally defined by the given radius.
	**/
	static function RandomXYZ(vec3:phaser.math.Vector3, ?radius:Float):phaser.math.Vector3;
	/**
		Compute a random four-dimensional vector.
	**/
	static function RandomXYZW(vec4:phaser.math.Vector4, ?scale:Float):phaser.math.Vector4;
	/**
		Rotate a given point by a given angle around the origin (0, 0), in an anti-clockwise direction.
	**/
	static function Rotate(point:ts.AnyOf2<Dynamic, phaser.geom.Point>, angle:Float):phaser.geom.Point;
	/**
	...
	**/
	static function RotateVec3(vec:phaser.math.Vector3, axis:phaser.math.Vector3, radians:Float):phaser.math.Vector3;
	/**
	...
	**/
	static function SinCosTableGenerator(length:Float, ?sinAmp:Float, ?cosAmp:Float, ?frequency:Float):phaser.types.math.SinCosTable;
	/**
	...
	**/
	static function ToXY(index:Float, width:Float, height:Float, ?out:phaser.math.Vector2):phaser.math.Vector2;
	/**
		Takes the `x` and `y` coordinates and transforms them into the same space as
		defined by the position, rotation and scale values.
	**/
	static function TransformXY(x:Float, y:Float, positionX:Float, positionY:Float, rotation:Float, scaleX:Float, scaleY:Float, ?output:ts.AnyOf3<Dynamic, phaser.math.Vector2, phaser.geom.Point>):ts.AnyOf3<Dynamic, phaser.math.Vector2, phaser.geom.Point>;
	/**
	...
	**/
	static var RND : phaser.math.RandomDataGenerator;
	/**
