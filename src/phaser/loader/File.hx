...
@:native("Phaser.Loader.File") extern class File {
	function new(loader:LoaderPlugin, fileConfig:phaser.types.loader.FileConfig);
	/**
	...
	**/
	var cache : ts.AnyOf2<phaser.textures.TextureManager, phaser.cache.BaseCache>;
	/**
	...
	**/
	var xhrLoader : Null<js.html.XMLHttpRequest>;
	/**
	...
	**/
	var multiFile : Null<MultiFile>;
	/**
		Does this file have an associated linked file? Such as an image and a normal map.
		Atlases and Bitmap Fonts use the multiFile, because those files need loading together but aren't
		actually bound by data, where-as a linkFile is.
	**/
	var linkFile : Null<File>;
	/**
	...
	**/
	function onLoad(xhr:js.html.XMLHttpRequest, event:js.html.ProgressEvent_<js.html.EventTarget>):Void;
	/**
		Called by the XHRLoader if it was given a File with base64 data to load.
	**/
	function onBase64Load(xhr:js.html.XMLHttpRequest):Void;
	/**
		Called if the file errors while loading, is sent a DOM ProgressEvent.
	**/
	function onError(xhr:js.html.XMLHttpRequest, event:js.html.ProgressEvent_<js.html.EventTarget>):Void;
	/**
		Called during the file load progress. Is sent a DOM ProgressEvent.
	**/
	function onProgress(event:js.html.ProgressEvent_<js.html.EventTarget>):Void;
	/**
