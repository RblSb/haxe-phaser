...
@:native("Phaser.Loader.LoaderPlugin") extern class LoaderPlugin extends phaser.events.EventEmitter {
	...
	**/
	function removePack(packKey:ts.AnyOf2<String, Dynamic>, ?dataKey:String):Void;
	/**
	...
	**/
	...
	/**
		...
		It is available in the default build but can be excluded from custom builds.
	**/
	function font(key:ts.AnyOf3<String, phaser.types.loader.filetypes.FontFileConfig, Array<phaser.types.loader.filetypes.FontFileConfig>>, ?url:String, ?format:String, ?descriptors:Dynamic, ?xhrSettings:phaser.types.loader.XHRSettingsObject):LoaderPlugin;
	/**
