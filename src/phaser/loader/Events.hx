...
@:native("Phaser.Loader.Events") @valueModuleOnly extern class Events {
	...
	**/
	static final FILE_COMPLETE : String;
	/**
		The File Load Complete Event.
	...
	**/
	static final FILE_KEY_COMPLETE : String;
	/**
	...
	**/
	static final FILE_LOAD_ERROR : String;
	/**
		The File Load Event.
	...
	**/
	static final FILE_PROGRESS : String;
	/**
	...
	**/
	static final POST_PROCESS : String;
	/**
