...
**/
@:native("Phaser.Loader.FileTypes.AnimationJSONFile") extern class AnimationJSONFile extends phaser.loader.File {
	function new(loader:phaser.loader.LoaderPlugin, key:ts.AnyOf2<String, phaser.types.loader.filetypes.JSONFileConfig>, ?url:String, ?xhrSettings:phaser.types.loader.XHRSettingsObject, ?dataKey:String);
	/**
