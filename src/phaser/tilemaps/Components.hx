...
@:native("Phaser.Tilemaps.Components") @valueModuleOnly extern class Components {
	...
	**/
	static function CheckIsoBounds(tileX:Float, tileY:Float, layer:LayerData, ?camera:phaser.cameras.scene2d.Camera):Bool;
	/**
	...
	**/
	static function CreateFromTiles(indexes:ts.AnyOf2<Float, Array<Float>>, replacements:Null<ts.AnyOf2<Float, Array<Float>>>, spriteConfig:phaser.types.gameobjects.sprite.SpriteConfig, scene:phaser.Scene, camera:phaser.cameras.scene2d.Camera, layer:LayerData):Array<phaser.gameobjects.Sprite>;
	/**
	...
	**/
	static function CullBounds(layer:LayerData, camera:phaser.cameras.scene2d.Camera):phaser.geom.Rectangle;
	/**
		Returns the tiles in the given layer that are within the cameras viewport. This is used internally.
	**/
	static function CullTiles(layer:LayerData, camera:phaser.cameras.scene2d.Camera, ?outputArray:Array<Dynamic>, ?renderOrder:Float):Array<Tile>;
	/**
	...
	**/
	static function FilterTiles(callback:haxe.Constraints.Function, context:Dynamic, tileX:Float, tileY:Float, width:Float, height:Float, filteringOptions:phaser.types.tilemaps.FilteringOptions, layer:LayerData):Array<Tile>;
	/**
		...
		the top-left.
	**/
	static function FindByIndex(index:Float, skip:Float, reverse:Bool, layer:LayerData):Null<Tile>;
	/**
		Find the first tile in the given rectangular area (in tile coordinates) of the layer that
		satisfies the provided testing function. I.e. finds the first tile for which `callback` returns
		true. Similar to Array.prototype.find in vanilla JS.
	**/
	static function FindTile(callback:FindTileCallback, context:Dynamic, tileX:Float, tileY:Float, width:Float, height:Float, filteringOptions:phaser.types.tilemaps.FilteringOptions, layer:LayerData):Null<Tile>;
	/**
		For each tile in the given rectangular area (in tile coordinates) of the layer, run the given
		callback. Similar to Array.prototype.forEach in vanilla JS.
	**/
	static function ForEachTile(callback:EachTileCallback, context:Dynamic, tileX:Float, tileY:Float, width:Float, height:Float, filteringOptions:phaser.types.tilemaps.FilteringOptions, layer:LayerData):Void;
	/**
	...
	**/
	static function GetTileAtWorldXY(worldX:Float, worldY:Float, nonNull:Bool, camera:phaser.cameras.scene2d.Camera, layer:LayerData):Tile;
	/**
		Gets the corners of the Tile as an array of Vector2s.
	**/
	static function GetTileCorners(tileX:Float, tileY:Float, camera:phaser.cameras.scene2d.Camera, layer:LayerData):Array<phaser.math.Vector2>;
	/**
	...
	**/
	static function GetTilesWithin(tileX:Float, tileY:Float, width:Float, height:Float, filteringOptions:phaser.types.tilemaps.FilteringOptions, layer:LayerData):Array<Tile>;
	/**
		Gets the tiles that overlap with the given shape in the given layer. The shape must be a Circle,
		Line, Rectangle or Triangle. The shape should be in world coordinates.
	**/
	static function GetTilesWithinShape(shape:ts.AnyOf4<phaser.geom.Triangle, phaser.geom.Circle, phaser.geom.Line, phaser.geom.Rectangle>, filteringOptions:phaser.types.tilemaps.FilteringOptions, camera:phaser.cameras.scene2d.Camera, layer:LayerData):Array<Tile>;
	/**
	...
	**/
	static function HasTileAt(tileX:Float, tileY:Float, layer:LayerData):Null<Bool>;
	/**
		Checks if there is a tile at the given location (in world coordinates) in the given layer. Returns
		false if there is no tile or if the tile at that location has an index of -1.
	**/
	static function HasTileAtWorldXY(worldX:Float, worldY:Float, camera:phaser.cameras.scene2d.Camera, layer:LayerData):Null<Bool>;
	/**
		Returns the bounds in the given layer that are within the camera's viewport.
		This is used internally by the cull tiles function.
	**/
	static function HexagonalCullBounds(layer:LayerData, camera:phaser.cameras.scene2d.Camera):Dynamic;
	/**
		Returns the tiles in the given layer that are within the cameras viewport. This is used internally.
	**/
	static function HexagonalCullTiles(layer:LayerData, camera:phaser.cameras.scene2d.Camera, ?outputArray:Array<Dynamic>, ?renderOrder:Float):Array<Tile>;
	/**
		Gets the corners of the Hexagonal Tile as an array of Vector2s.
	**/
	static function HexagonalGetTileCorners(tileX:Float, tileY:Float, camera:phaser.cameras.scene2d.Camera, layer:LayerData):Array<phaser.math.Vector2>;
	/**
		Converts from hexagonal tile XY coordinates (tile units) to world XY coordinates (pixels), factoring in the
		layer's position, scale and scroll. This will return a new Vector2 object or update the given
		`point` object.
	**/
	static function HexagonalTileToWorldXY(tileX:Float, tileY:Float, point:phaser.math.Vector2, camera:phaser.cameras.scene2d.Camera, layer:LayerData):phaser.math.Vector2;
	/**
		Converts from world XY coordinates (pixels) to hexagonal tile XY coordinates (tile units), factoring in the
		layer's position, scale and scroll. This will return a new Vector2 object or update the given
		`point` object.
	**/
	static function HexagonalWorldToTileXY(worldX:Float, worldY:Float, snapToFloor:Bool, point:phaser.math.Vector2, camera:phaser.cameras.scene2d.Camera, layer:LayerData):phaser.math.Vector2;
	/**
	...
	**/
	...
	/**
		Returns the tiles in the given layer that are within the cameras viewport. This is used internally.
	**/
	static function IsometricCullTiles(layer:LayerData, camera:phaser.cameras.scene2d.Camera, ?outputArray:Array<Dynamic>, ?renderOrder:Float):Array<Tile>;
	/**
		Converts from isometric tile XY coordinates (tile units) to world XY coordinates (pixels), factoring in the
		layer's position, scale and scroll. This will return a new Vector2 object or update the given
		`point` object.
	**/
	static function IsometricTileToWorldXY(tileX:Float, tileY:Float, point:phaser.math.Vector2, camera:phaser.cameras.scene2d.Camera, layer:LayerData):phaser.math.Vector2;
	/**
		Converts from world XY coordinates (pixels) to isometric tile XY coordinates (tile units), factoring in the
		layers position, scale and scroll. This will return a new Vector2 object or update the given
		`point` object.
	**/
	static function IsometricWorldToTileXY(worldX:Float, worldY:Float, snapToFloor:Bool, point:phaser.math.Vector2, camera:phaser.cameras.scene2d.Camera, layer:LayerData, ?originTop:Bool):phaser.math.Vector2;
	/**
	...
	**/
	static function PutTileAtWorldXY(tile:ts.AnyOf2<Float, Tile>, worldX:Float, worldY:Float, recalculateFaces:Bool, camera:phaser.cameras.scene2d.Camera, layer:LayerData):Tile;
	/**
	...
	**/
	...
	/**
		...
		collision information.
	**/
	static function RemoveTileAtWorldXY(worldX:Float, worldY:Float, replaceWithNull:Bool, recalculateFaces:Bool, camera:phaser.cameras.scene2d.Camera, layer:LayerData):Tile;
	/**
	...
	**/
	static function RenderDebug(graphics:phaser.gameobjects.Graphics, styleConfig:phaser.types.tilemaps.DebugStyleOptions, layer:LayerData):Void;
	/**
	...
	**/
	...
	/**
		...
		This is used internally by the cull tiles function.
	**/
	static function StaggeredCullBounds(layer:LayerData, camera:phaser.cameras.scene2d.Camera):Dynamic;
	/**
		Returns the tiles in the given layer that are within the cameras viewport. This is used internally.
	**/
	static function StaggeredCullTiles(layer:LayerData, camera:phaser.cameras.scene2d.Camera, ?outputArray:Array<Dynamic>, ?renderOrder:Float):Array<Tile>;
	/**
		Converts from staggered tile XY coordinates (tile units) to world XY coordinates (pixels), factoring in the
		layer's position, scale and scroll. This will return a new Vector2 object or update the given
		`point` object.
	**/
	static function StaggeredTileToWorldXY(tileX:Float, tileY:Float, point:phaser.math.Vector2, camera:phaser.cameras.scene2d.Camera, layer:LayerData):phaser.math.Vector2;
	/**
		Converts from staggered tile Y coordinates (tile units) to world Y coordinates (pixels), factoring in the
		layers position, scale and scroll.
	**/
	static function StaggeredTileToWorldY(tileY:Float, camera:phaser.cameras.scene2d.Camera, layer:LayerData):Float;
	/**
		Converts from world XY coordinates (pixels) to staggered tile XY coordinates (tile units), factoring in the
		layer's position, scale and scroll. This will return a new Vector2 object or update the given
		`point` object.
	**/
	static function StaggeredWorldToTileXY(worldX:Float, worldY:Float, snapToFloor:Bool, point:phaser.math.Vector2, camera:phaser.cameras.scene2d.Camera, layer:LayerData):phaser.math.Vector2;
	/**
		Converts from world Y coordinates (pixels) to staggered tile Y coordinates (tile units), factoring in the
		layers position, scale and scroll.
	**/
	static function StaggeredWorldToTileY(worldY:Float, snapToFloor:Bool, camera:phaser.cameras.scene2d.Camera, layer:LayerData):Float;
	/**
		Scans the given rectangular area (given in tile coordinates) for tiles with an index matching
	...
	**/
	static function TileToWorldX(tileX:Float, camera:phaser.cameras.scene2d.Camera, layer:LayerData):Float;
	/**
		Converts from tile XY coordinates (tile units) to world XY coordinates (pixels), factoring in the
		layer's position, scale and scroll. This will return a new Vector2 object or update the given
		`point` object.
	**/
	static function TileToWorldXY(tileX:Float, tileY:Float, point:phaser.math.Vector2, camera:phaser.cameras.scene2d.Camera, layer:LayerData):phaser.math.Vector2;
	/**
		Converts from tile Y coordinates (tile units) to world Y coordinates (pixels), factoring in the
		layer's position, scale and scroll.
	**/
	static function TileToWorldY(tileY:Float, camera:phaser.cameras.scene2d.Camera, layer:LayerData):Float;
	/**
		Randomizes the indexes of a rectangular region of tiles (in tile coordinates) within the
	...
	**/
	...
	/**
		...
		layer's position, scale and scroll.
	**/
	static function WorldToTileX(worldX:Float, snapToFloor:Bool, camera:Null<phaser.cameras.scene2d.Camera>, layer:LayerData):Float;
	/**
		Converts from world XY coordinates (pixels) to tile XY coordinates (tile units), factoring in the
		layer's position, scale and scroll. This will return a new Vector2 object or update the given
		`point` object.
	**/
	static function WorldToTileXY(worldX:Float, worldY:Float, snapToFloor:Bool, point:phaser.math.Vector2, camera:phaser.cameras.scene2d.Camera, layer:LayerData):phaser.math.Vector2;
	/**
		Converts from world Y coordinates (pixels) to tile Y coordinates (tile units), factoring in the
		layer's position, scale and scroll.
	**/
	static function WorldToTileY(worldY:Float, snapToFloor:Bool, camera:Null<phaser.cameras.scene2d.Camera>, layer:LayerData):Float;
}