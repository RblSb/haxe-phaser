...
@:native("Phaser.Tilemaps.Tileset") extern class Tileset {
	...
	**/
	var tileOffset : phaser.math.Vector2;
	/**
		The cached image that contains the individual tiles. Use setImage to set.
	**/
	final image : Null<phaser.textures.Texture>;
	/**
		The gl texture used by the WebGL renderer.
	**/
	final glTexture : Null<phaser.renderer.webgl.wrappers.WebGLTextureWrapper>;
	/**
	...
	**/
	function getTileCollisionGroup(tileIndex:Float):Null<Dynamic>;
	/**
	...
	**/
	function getTileTextureCoordinates(tileIndex:Float):Null<Dynamic>;
	/**
		Sets the image associated with this Tileset and updates the tile data (rows, columns, etc.).
	**/
	function setImage(texture:phaser.textures.Texture):Tileset;
	/**
	...
	**/
	function updateTileData(imageWidth:Float, imageHeight:Float, ?offsetX:Float, ?offsetY:Float):Tileset;
