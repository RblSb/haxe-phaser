...
@:native("Phaser.Input.Pointer") extern class Pointer {
	...
	**/
	var event : ts.AnyOf3<js.html.TouchEvent, js.html.MouseEvent, js.html.WheelEvent>;
	/**
	...
	**/
	final position : phaser.math.Vector2;
	/**
	...
	**/
	final prevPosition : phaser.math.Vector2;
	/**
	...
	**/
	function updateWorldPoint(camera:phaser.cameras.scene2d.Camera):Pointer;
	/**
		Takes a Camera and returns a Vector2 containing the translated position of this Pointer
		within that Camera. This can be used to convert this Pointers position into camera space.
	**/
	function positionToCamera(camera:phaser.cameras.scene2d.Camera, ?output:ts.AnyOf2<Dynamic, phaser.math.Vector2>):ts.AnyOf2<Dynamic, phaser.math.Vector2>;
	/**
