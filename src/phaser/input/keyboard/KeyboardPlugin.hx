...
**/
@:native("Phaser.Input.Keyboard.KeyboardPlugin") extern class KeyboardPlugin extends phaser.events.EventEmitter {
	function new(sceneInputPlugin:phaser.input.InputPlugin);
	/**
	...
	**/
	var sceneInputPlugin : phaser.input.InputPlugin;
	/**
	...
	**/
	function createCursorKeys():phaser.types.input.keyboard.CursorKeys;
	/**
	...
	**/
	function removeKey(key:ts.AnyOf3<String, Float, Key>, ?destroy:Bool, ?removeCapture:Bool):KeyboardPlugin;
	/**
		Removes all Key objects created by _this_ Keyboard Plugin.
	**/
	function removeAllKeys(?destroy:Bool, ?removeCapture:Bool):KeyboardPlugin;
	/**
		...
		```
	**/
	function createCombo(keys:ts.AnyOf3<String, Array<Float>, Array<Dynamic>>, ?config:phaser.types.input.keyboard.KeyComboConfig):KeyCombo;
	/**
