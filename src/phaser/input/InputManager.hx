...
@:native("Phaser.Input.InputManager") extern class InputManager {
	...
	**/
	var keyboard : Null<phaser.input.keyboard.KeyboardManager>;
	/**
	...
	**/
	var touch : phaser.input.touch.TouchManager;
	/**
	...
	**/
	function hitTest(pointer:Pointer, gameObjects:Array<Dynamic>, camera:phaser.cameras.scene2d.Camera, ?output:Array<Dynamic>):Array<Dynamic>;
	/**
	...
	**/
	function pointWithinHitArea(gameObject:phaser.gameobjects.GameObject, x:Float, y:Float):Bool;
	/**
	...
	**/
	function pointWithinInteractiveObject(object:phaser.types.input.InteractiveObject, x:Float, y:Float):Bool;
	/**
