...
@:native("Phaser.Input.InputPlugin") extern class InputPlugin extends phaser.events.EventEmitter {
	...
	**/
	var mouse : Null<phaser.input.mouse.MouseManager>;
	/**
	...
	**/
	function clear(gameObject:phaser.gameobjects.GameObject, ?skipQueue:Bool):phaser.gameobjects.GameObject;
	/**
	...
	**/
	function enable(gameObject:phaser.gameobjects.GameObject, ?hitArea:Dynamic, ?hitAreaCallback:phaser.types.input.HitAreaCallback, ?dropZone:Bool):InputPlugin;
	/**
	...
	**/
	function hitTestPointer(pointer:Pointer):Array<phaser.gameobjects.GameObject>;
	/**
	...
	**/
	function setDraggable(gameObjects:ts.AnyOf2<phaser.gameobjects.GameObject, Array<phaser.gameobjects.GameObject>>, ?value:Bool):InputPlugin;
	/**
	...
	**/
	function setHitArea(gameObjects:ts.AnyOf2<phaser.gameobjects.GameObject, Array<phaser.gameobjects.GameObject>>, ?hitArea:Dynamic, ?hitAreaCallback:phaser.types.input.HitAreaCallback):InputPlugin;
	/**
		Sets the hit area for an array of Game Objects to be a `Phaser.Geom.Circle` shape, using
		the given coordinates and radius to control its position and size.
	**/
	function setHitAreaCircle(gameObjects:ts.AnyOf2<phaser.gameobjects.GameObject, Array<phaser.gameobjects.GameObject>>, x:Float, y:Float, radius:Float, ?callback:phaser.types.input.HitAreaCallback):InputPlugin;
	/**
		Sets the hit area for an array of Game Objects to be a `Phaser.Geom.Ellipse` shape, using
		the given coordinates and dimensions to control its position and size.
	**/
	function setHitAreaEllipse(gameObjects:ts.AnyOf2<phaser.gameobjects.GameObject, Array<phaser.gameobjects.GameObject>>, x:Float, y:Float, width:Float, height:Float, ?callback:phaser.types.input.HitAreaCallback):InputPlugin;
	/**
		Sets the hit area for an array of Game Objects to be a `Phaser.Geom.Rectangle` shape, using
		the Game Objects texture frame to define the position and size of the hit area.
	**/
	function setHitAreaFromTexture(gameObjects:ts.AnyOf2<phaser.gameobjects.GameObject, Array<phaser.gameobjects.GameObject>>, ?callback:phaser.types.input.HitAreaCallback):InputPlugin;
	/**
		Sets the hit area for an array of Game Objects to be a `Phaser.Geom.Rectangle` shape, using
		the given coordinates and dimensions to control its position and size.
	**/
	function setHitAreaRectangle(gameObjects:ts.AnyOf2<phaser.gameobjects.GameObject, Array<phaser.gameobjects.GameObject>>, x:Float, y:Float, width:Float, height:Float, ?callback:phaser.types.input.HitAreaCallback):InputPlugin;
	/**
	...
	**/
	function setHitAreaTriangle(gameObjects:ts.AnyOf2<phaser.gameobjects.GameObject, Array<phaser.gameobjects.GameObject>>, x1:Float, y1:Float, x2:Float, y2:Float, x3:Float, y3:Float, ?callback:phaser.types.input.HitAreaCallback):InputPlugin;
	/**
		...
		work.
	**/
	function enableDebug(gameObject:phaser.gameobjects.GameObject, ?color:Float):InputPlugin;
	/**
	...
	**/
	function removeDebug(gameObject:phaser.gameobjects.GameObject):InputPlugin;
	/**
	...
	**/
	function sortGameObjects(gameObjects:Array<phaser.gameobjects.GameObject>, pointer:Pointer):Array<phaser.gameobjects.GameObject>;
	/**
	...
	**/
	function sortDropZones(gameObjects:Array<phaser.gameobjects.GameObject>):Array<phaser.gameobjects.GameObject>;
	/**
	...
	**/
	var keyboard : Null<phaser.input.keyboard.KeyboardPlugin>;
	/**
