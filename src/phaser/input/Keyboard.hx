...
@:native("Phaser.Input.Keyboard") @valueModuleOnly extern class Keyboard {
	...
	**/
	static function DownDuration(key:phaser.input.keyboard.Key, ?duration:Float):Bool;
	/**
	...
	**/
	static function JustDown(key:phaser.input.keyboard.Key):Bool;
	/**
	...
	**/
	static function JustUp(key:phaser.input.keyboard.Key):Bool;
	/**
	...
	**/
	static function UpDuration(key:phaser.input.keyboard.Key, ?duration:Float):Bool;
}