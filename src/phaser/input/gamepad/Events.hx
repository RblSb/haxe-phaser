...
@:native("Phaser.Input.Gamepad.Events") @valueModuleOnly extern class Events {
	...
	**/
	static final BUTTON_DOWN : String;
	/**
	...
	**/
	static final DISCONNECTED : String;
	/**
		The Gamepad Button Down Event.
	...
	**/
	static final GAMEPAD_BUTTON_DOWN : String;
	/**
		The Gamepad Button Up Event.
	...
	**/
	static final GAMEPAD_BUTTON_UP : String;
}