...
**/
@:native("Phaser.Input.Gamepad.Gamepad") extern class Gamepad extends phaser.events.EventEmitter {
	function new(manager:GamepadPlugin, pad:phaser.types.input.gamepad.Pad);
	/**
	...
	**/
	var leftStick : phaser.math.Vector2;
	/**
	...
	**/
	var rightStick : phaser.math.Vector2;
	/**
