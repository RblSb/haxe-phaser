...
@:native("Phaser.Animations.AnimationState") extern class AnimationState {
	function new(parent:phaser.gameobjects.GameObject);
	/**
	...
	**/
	private var textureManager : phaser.textures.TextureManager;
	/**
	...
	**/
	private var anims : phaser.structs.Map_<String, Animation>;
	/**
	...
	**/
	var currentAnim : Null<Animation>;
	/**
	...
	**/
	var nextAnim : Null<ts.AnyOf3<String, Animation, phaser.types.animations.PlayAnimationConfig>>;
	/**
	...
	**/
	function chain(?key:ts.AnyOf6<String, Array<String>, Animation, phaser.types.animations.PlayAnimationConfig, Array<Animation>, Array<phaser.types.animations.PlayAnimationConfig>>):phaser.gameobjects.GameObject;
	/**
	...
	**/
	private function load(key:ts.AnyOf2<String, phaser.types.animations.PlayAnimationConfig>):phaser.gameobjects.GameObject;
	/**
		Pause the current animation and set the `isPlaying` property to `false`.
		You can optionally pause it at a specific frame.
	**/
	function pause(?atFrame:AnimationFrame):phaser.gameobjects.GameObject;
	/**
		Resumes playback of a paused animation and sets the `isPlaying` property to `true`.
		You can optionally tell it to start playback from a specific frame.
	**/
	function resume(?fromFrame:AnimationFrame):phaser.gameobjects.GameObject;
	/**
	...
	**/
	function playAfterDelay(key:ts.AnyOf3<String, Animation, phaser.types.animations.PlayAnimationConfig>, delay:Float):phaser.gameobjects.GameObject;
	/**
	...
	**/
	function playAfterRepeat(key:ts.AnyOf3<String, Animation, phaser.types.animations.PlayAnimationConfig>, ?repeatCount:Float):phaser.gameobjects.GameObject;
	/**
	...
	**/
	function play(key:ts.AnyOf3<String, Animation, phaser.types.animations.PlayAnimationConfig>, ?ignoreIfPlaying:Bool):phaser.gameobjects.GameObject;
	/**
		...
		Also, see the documentation in the Animation Manager for further details on creating animations.
	**/
	function playReverse(key:ts.AnyOf3<String, Animation, phaser.types.animations.PlayAnimationConfig>, ?ignoreIfPlaying:Bool):phaser.gameobjects.GameObject;
	/**
	...
	**/
	function startAnimation(key:ts.AnyOf2<String, phaser.types.animations.PlayAnimationConfig>):phaser.gameobjects.GameObject;
	/**
		Reverse the Animation that is already playing on the Game Object.
	**/
	function reverse():phaser.gameobjects.GameObject;
	/**
	...
	**/
	...
	/**
		...
		the duration of the animation.
	**/
	function setProgress(?value:Float):phaser.gameobjects.GameObject;
	/**
	...
	**/
	function setRepeat(value:Float):phaser.gameobjects.GameObject;
	/**
	...
	**/
	function restart(?includeDelay:Bool, ?resetRepeats:Bool):phaser.gameobjects.GameObject;
	/**
	...
	**/
	function complete():phaser.gameobjects.GameObject;
	/**
	...
	**/
	function stop():phaser.gameobjects.GameObject;
	/**
	...
	**/
	function stopAfterDelay(delay:Float):phaser.gameobjects.GameObject;
	/**
	...
	**/
	function stopAfterRepeat(?repeatCount:Float):phaser.gameobjects.GameObject;
	/**
		...
		when the current one stops.
	**/
	function stopOnFrame(frame:AnimationFrame):phaser.gameobjects.GameObject;
	/**
	...
	**/
	function setCurrentFrame(animationFrame:AnimationFrame):phaser.gameobjects.GameObject;
	/**
	...
	**/
	function nextFrame():phaser.gameobjects.GameObject;
	/**
	...
	**/
	function previousFrame():phaser.gameobjects.GameObject;
	/**
	...
	**/
	function create(config:phaser.types.animations.Animation):ts.AnyOf2<Bool, Animation>;
	/**
	...
	**/
	function generateFrameNames(key:String, ?config:phaser.types.animations.GenerateFrameNames):Array<phaser.types.animations.AnimationFrame>;
	/**
		Generate an array of {@link Phaser.Types.Animations.AnimationFrame} objects from a texture key and configuration object.
	...
	**/
	function generateFrameNumbers(key:String, ?config:phaser.types.animations.GenerateFrameNumbers):Array<phaser.types.animations.AnimationFrame>;
	/**
