...
@:native("Phaser.Animations.Animation") extern class Animation {
	function new(manager:AnimationManager, key:String, config:phaser.types.animations.Animation);
	/**
	...
	**/
	function addFrame(config:ts.AnyOf2<String, Array<phaser.types.animations.AnimationFrame>>):Animation;
	/**
		Add frame/s into the animation.
	**/
	function addFrameAt(index:Float, config:ts.AnyOf2<String, Array<phaser.types.animations.AnimationFrame>>):Animation;
	/**
	...
	**/
	function getFrameAt(index:Float):AnimationFrame;
	/**
		Creates AnimationFrame instances based on the given frame data.
	**/
	function getFrames(textureManager:phaser.textures.TextureManager, frames:ts.AnyOf2<String, Array<phaser.types.animations.AnimationFrame>>, ?defaultTextureKey:String):Array<AnimationFrame>;
	/**
	...
	**/
	function toJSON():phaser.types.animations.JSONAnimation;
	/**
