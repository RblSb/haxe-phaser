...
@:native("Phaser.Animations.Events") @valueModuleOnly extern class Events {
	...
	**/
	static final ADD_ANIMATION : String;
	/**
	...
	**/
	static final ANIMATION_COMPLETE : String;
	/**
		...
		If the animation is restarted while it is already playing, `ANIMATION_RESTART` is emitted.
	**/
	static final ANIMATION_COMPLETE_KEY : String;
	/**
		...
		If the animation is restarted while it is already playing, `ANIMATION_RESTART` is emitted.
	**/
	static final ANIMATION_REPEAT : String;
	/**
		...
		If the animation is restarted while it is already playing, `ANIMATION_RESTART` is emitted.
	**/
	static final ANIMATION_RESTART : String;
	/**
		...
		If the animation is restarted while it is already playing, `ANIMATION_RESTART` is emitted.
	**/
	static final ANIMATION_START : String;
	/**
		...
		If the animation is restarted while it is already playing, `ANIMATION_RESTART` is emitted.
	**/
	static final ANIMATION_STOP : String;
	/**
		...
		If the animation is restarted while it is already playing, `ANIMATION_RESTART` is emitted.
	**/
	static final ANIMATION_UPDATE : String;
	/**
	...
	**/
	static final REMOVE_ANIMATION : String;
	/**
