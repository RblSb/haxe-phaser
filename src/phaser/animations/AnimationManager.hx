...
**/
@:native("Phaser.Animations.AnimationManager") extern class AnimationManager extends phaser.events.EventEmitter {
	...
	**/
	var mixes : phaser.structs.Map_<String, Animation>;
	/**
	...
	**/
	function createFromAseprite(key:String, ?tags:Array<String>, ?target:ts.AnyOf2<phaser.gameobjects.GameObject, AnimationManager>):Array<Animation>;
	/**
	...
	**/
	function fromJSON(data:ts.AnyOf3<String, phaser.types.animations.JSONAnimation, phaser.types.animations.JSONAnimations>, ?clearCurrentAnimations:Bool):Array<Animation>;
	/**
	...
	**/
	function getAnimsFromTexture(key:ts.AnyOf3<String, phaser.textures.Frame, phaser.textures.Texture>):Array<String>;
	/**
	...
	**/
	function play(key:ts.AnyOf3<String, Animation, phaser.types.animations.PlayAnimationConfig>, children:ts.AnyOf2<phaser.gameobjects.GameObject, Array<phaser.gameobjects.GameObject>>):AnimationManager;
	/**
		...
		child 4: 0ms delay
	**/
	function staggerPlay<G>(key:ts.AnyOf3<String, Animation, phaser.types.animations.PlayAnimationConfig>, children:ts.AnyOf2<phaser.gameobjects.GameObject, Array<phaser.gameobjects.GameObject>>, stagger:Float, ?staggerFirst:Bool):G;
	/**
	...
	**/
	function toJSON(?key:String):phaser.types.animations.JSONAnimations;
	/**
