...
extern class SpineGameObject extends phaser.gameobjects.GameObject 
{
    ...
    public function angleBoneToXY(bone: Bone, worldX: Float, worldY: Float, ?offset: Float, ?minAngle: Float, ?maxAngle: Float): SpineGameObject;
    ...
    public function getCurrentAnimation(?trackIndex: Float): Animation;
    ...
    public function setAnimation(trackIndex: Float, animationName: String, ?loop: Bool, ?ignoreIfPlaying: Bool): TrackEntry;
    ...
    public function setSkin(newSkin: Skin): SpineGameObject;
